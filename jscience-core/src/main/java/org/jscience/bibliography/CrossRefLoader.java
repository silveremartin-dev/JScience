...
public class CrossRefLoader {
    ...
    static {
        ...
        try (java.io.InputStream is = CrossRefLoader.class.getResourceAsStream("/jscience.properties")) {
            if (is != null)
                props.load(is);
        } catch (Exception e) {
            /* ignore */ }
        API_URL = props.getProperty("crossref.api.url", "https://api.crossref.org/works/");
        SEARCH_URL = props.getProperty("crossref.search.url", "https://api.crossref.org/works?query=");
    }
