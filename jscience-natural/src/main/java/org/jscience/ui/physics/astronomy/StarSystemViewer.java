...
/**
 * 3D Star System Viewer using JavaFX.
 * Provides interactive visualization of celestial systems.
 * 
 * @author Silvere Martin-Michiellot
 * @author Gemini AI
 * @since 5.0
 */
public class StarSystemViewer {
    ...
    public StarSystemViewer(Stage stage) {
        this.stage = stage;
    }
    ...
    /**
     * Creates viewer and displays the given star system.
     */
    public static void show(Stage stage, StarSystem system) {
        StarSystemViewer viewer = new StarSystemViewer(stage);
