...
public class EarthquakeMapViewer extends Application {
    ...
    public void start(Stage stage) {
        ...
        Label explainLabel = new Label(
                "Visualization of global seismic activity.\n\n" +
                        "Data shows the 'Ring of Fire' pattern:\n" +
                        "• Pacific Rim (West Americas)\n" +
                        "• Japan & East Asia\n" +
                        "• Indonesia\n\n" +
                        "Mouse Controls:\n" +
                        "• Drag to pan\n" +
        ...
        legend.getChildren().addAll(
                createLegendItem(Color.hsb(120, 1, 1), "< 3.0 (Minor)"),
                createLegendItem(Color.hsb(80, 1, 1), "3.0-5.0 (Light)"),
                createLegendItem(Color.hsb(40, 1, 1), "5.0-6.0 (Moderate)"),
        ...
        canvas.setOnMouseMoved(e -> {
            ...
            infoLabel.setText("Hover over quake for details");
        });
    ...
    private void draw(GraphicsContext gc, long now) {
        ...
        gc.fillText(quakes.size() + " earthquakes", 10, 35);
    }
