...
/**
    ...
    public boolean equals(Object a) {
        if (a instanceof Rank2Tensor) {
            ...
            for (int i = 0; i < 4; i++) {
                if ((Math.abs(rank2[i][0] - v.rank2[i][0]) > Double.valueOf(
                            JScience.getProperty("tolerance")).doubleValue()) ||
                        (Math.abs(rank2[i][1] - v.rank2[i][1]) > Double.valueOf(
                            JScience.getProperty("tolerance")).doubleValue()) ||
                        (Math.abs(rank2[i][2] - v.rank2[i][2]) > Double.valueOf(
                            JScience.getProperty("tolerance")).doubleValue()) ||
                        (Math.abs(rank2[i][3] - v.rank2[i][3]) > Double.valueOf(
                            JScience.getProperty("tolerance")).doubleValue())) {
                    return false;
                }
            }
    ...
    public Rank1Tensor multiply(Rank1Tensor t) {
        ...
        ans.setComponent(0,
            (rank2[0][0] * t.getComponent(0)) +
            (rank2[0][1] * t.getComponent(1)) +
            (rank2[0][2] * t.getComponent(2)) +
            (rank2[0][3] * t.getComponent(3)));
        ans.setComponent(1,
            (rank2[1][0] * t.getComponent(0)) +
            (rank2[1][1] * t.getComponent(1)) +
            (rank2[1][2] * t.getComponent(2)) +
            (rank2[1][3] * t.getComponent(3)));
        ans.setComponent(2,
            (rank2[2][0] * t.getComponent(0)) +
            (rank2[2][1] * t.getComponent(1)) +
            (rank2[2][2] * t.getComponent(2)) +
            (rank2[2][3] * t.getComponent(3)));
        ans.setComponent(3,
            (rank2[3][0] * t.getComponent(0)) +
            (rank2[3][1] * t.getComponent(1)) +
            (rank2[3][2] * t.getComponent(2)) +
            (rank2[3][3] * t.getComponent(3)));
