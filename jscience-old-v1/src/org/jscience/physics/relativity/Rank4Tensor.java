    ...
    public boolean equals(Object a) {
        if (a instanceof Rank4Tensor) {
            ...
            for (int k, j, i = 0; i < 4; i++) {
                for (j = 0; j < 4; j++) {
                    for (k = 0; k < 4; k++) {
                        if ((Math.abs(rank4[i][j][k][0] - v.rank4[i][j][k][0]) > Double.valueOf(
                                    JScience.getProperty("tolerance"))
                                                                                           .doubleValue()) ||
                                (Math.abs(rank4[i][j][k][1] -
                                    v.rank4[i][j][k][1]) > Double.valueOf(
                                    JScience.getProperty("tolerance"))
                                                                     .doubleValue()) ||
                                (Math.abs(rank4[i][j][k][2] -
                                    v.rank4[i][j][k][2]) > Double.valueOf(
                                    JScience.getProperty("tolerance"))
                                                                     .doubleValue()) ||
                                (Math.abs(rank4[i][j][k][3] -
                                    v.rank4[i][j][k][3]) > Double.valueOf(
                                    JScience.getProperty("tolerance"))
                                                                     .doubleValue())) {
                            return false;
                        }
            ...
            for (j = 0; j < 4; j++) {
                for (k = 0; k < 4; k++) {
                    ans.setComponent(i, j, k, 0,
                        rank4[i][j][k][0] + t.rank4[i][j][k][0]);
                    ans.setComponent(i, j, k, 1,
                        rank4[i][j][k][1] + t.rank4[i][j][k][1]);
                    ans.setComponent(i, j, k, 2,
                        rank4[i][j][k][2] + t.rank4[i][j][k][2]);
                    ans.setComponent(i, j, k, 3,
                        rank4[i][j][k][3] + t.rank4[i][j][k][3]);
                }
            }
        }
