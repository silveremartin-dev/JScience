...
public class Kernel {
    ...
    /** DOCUMENT ME! */
    public static float[] EDGE_LAPLACE1 = { 0, -1, 0, -1, 4, -1, 0, -1, 0, };

    /** DOCUMENT ME! */
    public static float[] EDGE_LAPLACE2 = { -1, -1, -1, -1, 8, -1, -1, -1, -1, };
...
/**
     * Construct a null kernel. This is only useful if you're going to change
     * the kernel later on.
     */
    public Kernel() {
        this(new float[9]);
...
/**
     ...
     * @param matrix an array of rowscols floats containing the kernel
     */
...
/**
     ...
     * @param matrix an array of rowscols floats containing the kernel
     */
    public void setMatrix(int rows, int cols, int xCentre, int yCentre,
        float[] matrix) {
        this.rows = rows;
        this.cols = cols;
    ...
    /**
     * Normalize a convolution kernel. You can call this to normalize a
     * kernel you've created by hand.
     */
