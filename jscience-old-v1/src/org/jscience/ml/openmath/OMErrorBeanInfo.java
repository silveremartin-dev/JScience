/*
 * $Id: OMErrorBeanInfo.java,v 1.3 2007-10-23 18:21:21 virtualcall Exp $
 *
...
/**
 * Bean info class for the OMError class.<p></p>
 *
 * @author Manfred N. Riem (mriem@manorrock.org)
 * @version $Revision: 1.3 $
 */
public class OMErrorBeanInfo extends SimpleBeanInfo {
    /**
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor symbol = new PropertyDescriptor("symbol",
                    OMError.class);
            PropertyDescriptor elements = new PropertyDescriptor("elements",
                    OMError.class);
            PropertyDescriptor[] array = { symbol, elements };
