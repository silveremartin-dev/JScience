/*
 * $Id: OMSymbolBeanInfo.java,v 1.3 2007-10-23 18:21:22 virtualcall Exp $
 *
...
/**
 * Bean info class for the OMSymbol class.<p></p>
 *
 * @author Manfred N. Riem (mriem@manorrock.org)
 * @version $Revision: 1.3 $
 */
public class OMSymbolBeanInfo extends SimpleBeanInfo {
    /**
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor name = new PropertyDescriptor("name",
                    OMSymbol.class);
            PropertyDescriptor cd = new PropertyDescriptor("cd", OMSymbol.class);
            PropertyDescriptor[] array = { name, cd };
