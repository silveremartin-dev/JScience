/*
 * $Id: OMBindingBeanInfo.java,v 1.3 2007-10-23 18:21:21 virtualcall Exp $
 *
...
/**
 * Bean info class for the OMBinding class.<p></p>
 *
 * @author Manfred N. Riem (mriem@manorrock.org)
 * @version $Revision: 1.3 $
 */
public class OMBindingBeanInfo extends SimpleBeanInfo {
    /**
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor binder = new PropertyDescriptor("binder",
                    OMBinding.class);
            PropertyDescriptor variables = new PropertyDescriptor("variables",
                    OMBinding.class);
            PropertyDescriptor body = new PropertyDescriptor("body",
                    OMBinding.class);

            PropertyDescriptor[] array = { binder, variables, body };
