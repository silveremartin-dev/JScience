/*
 * $Id: OMStringBeanInfo.java,v 1.3 2007-10-23 18:21:22 virtualcall Exp $
 *
...
/**
 * Bean info class for the OMString class.<p></p>
 *
 * @author Manfred N. Riem (mriem@manorrock.org)
 * @version $Revision: 1.3 $
 */
public class OMStringBeanInfo extends SimpleBeanInfo {
    /**
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor string = new PropertyDescriptor("string",
                    OMString.class);
            PropertyDescriptor[] array = { string };
