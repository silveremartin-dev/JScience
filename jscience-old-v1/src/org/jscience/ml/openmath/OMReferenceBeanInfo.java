/*
 * $Id: OMReferenceBeanInfo.java,v 1.3 2007-10-23 18:21:21 virtualcall Exp $
 *
...
/**
 * Bean info class for the OMReference class.<p></p>
 *
 * @author Manfred N. Riem (mriem@manorrock.org)
 * @version $Revision: 1.3 $
 */
public class OMReferenceBeanInfo extends SimpleBeanInfo {
    /**
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor href = new PropertyDescriptor("href",
                    OMReference.class);
            PropertyDescriptor[] array = { href };
