/*
 * $Id: OMApplicationBeanInfo.java,v 1.3 2007-10-23 18:21:20 virtualcall Exp $
 *
...
/**
 * Bean info class for the OMApplication class.<p></p>
 *
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor elements = new PropertyDescriptor("elements",
                    OMApplication.class);
            PropertyDescriptor[] array = { elements };
