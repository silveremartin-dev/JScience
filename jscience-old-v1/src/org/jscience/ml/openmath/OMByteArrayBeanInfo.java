/*
 * $Id: OMByteArrayBeanInfo.java,v 1.3 2007-10-23 18:21:21 virtualcall Exp $
 *
...
/**
 * Bean info class for the OMByteArray class.<p></p>
 *
 * @author Manfred N. Riem (mriem@manorrock.org)
 * @version $Revision: 1.3 $
 */
public class OMByteArrayBeanInfo extends SimpleBeanInfo {
    /**
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor byteArray = new PropertyDescriptor("byteArray",
                    OMByteArray.class);
            PropertyDescriptor[] array = { byteArray };
