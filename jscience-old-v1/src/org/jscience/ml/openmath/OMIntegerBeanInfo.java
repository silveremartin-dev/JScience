/*
 * $Id: OMIntegerBeanInfo.java,v 1.3 2007-10-23 18:21:21 virtualcall Exp $
 *
...
/**
 * Bean info class for the OMInteger class.<p></p>
 *
 * @author Manfred N. Riem (mriem@manorrock.org)
 * @version $Revision: 1.3 $
 */
public class OMIntegerBeanInfo extends SimpleBeanInfo {
    /**
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor integer = new PropertyDescriptor("integer",
                    OMInteger.class);
            PropertyDescriptor[] array = { integer };
