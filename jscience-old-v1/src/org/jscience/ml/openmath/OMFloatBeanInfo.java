/*
 * $Id: OMFloatBeanInfo.java,v 1.3 2007-10-23 18:21:21 virtualcall Exp $
 *
...
/**
 * Bean info class for the OMFloat class.<p></p>
 *
 * @author Manfred N. Riem (mriem@manorrock.org)
 * @version $Revision: 1.3 $
 */
public class OMFloatBeanInfo extends SimpleBeanInfo {
    /**
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        try {
            PropertyDescriptor pFloat = new PropertyDescriptor("float",
                    OMFloat.class);
            PropertyDescriptor pBase = new PropertyDescriptor("base",
                    OMFloat.class);
            PropertyDescriptor[] array = { pFloat, pBase };
