...
public class GedcomParser implements XMLReader, Locator {
    ...
    public void parse(String systemId) throws SAXException, IOException {
        ...
        parse(new BufferedReader(new AnselInputStreamReader((new URL(systemId)).openStream())));
    }
    ...
    public void parse(InputSource source) throws SAXException, IOException {
        ...
        if (source.getCharacterStream() != null) {
            ...
            parse(new BufferedReader(new AnselInputStreamReader(source.getByteStream())));
        ...
        try {
            while ((line = reader.readLine()) != null) {
                ...
                if (line.length() > 0) {
                    ...
                    if (tag.equals("CHAR") &&
                            !(valu.trim().equals("ANSEL") ||
                                    valu.trim().equals("ASCII"))) {
                        System.err.println("WARNING: Character set is " + valu +
                                ": should be ANSEL or ASCII");
                    }
                    ...
                    if (valu.length() > 0) {
                        contentHandler.characters(valu.toCharArray(), 0,
                                valu.length());
                    }
                }
            } // end while
