...
/**
    ...
    */
    public int read() throws IOException {
        ...
        if (b < 0) {
            return b; // return EOF unchanged
        }

        pending = input.read();

        if (b < 128) {
            return b; // return ASCII characters unchanged
        }
    ...
    */
    private int convert1(int ansel) {
        ...
        default:
            return 0xFFFD; // if no match, use Unicode REPLACEMENT CHARACTER
        } //end switch
    }
