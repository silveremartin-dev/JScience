...
public class ParserTokenManager implements ParserConstants {
    ...
    final static int[] jjnextStates = {
            13, 14, 15, 20, 21, 7, 9, 10, 11, 3, 4, 18, 19, 22, 23,
        };

    /** DOCUMENT ME! */
    public final static String[] jjstrLiteralImages = {
            "", null, null, null, null, null, null, null, null, "\134", "\76",
            "\74", "\75", "\74\75", "\76\75", "\41\75", "\101\116\104",
            "\117\122", "\130\117\122", "\116\117\124", "\53", "\55", "\52",
            "\57", "\136", "\151\146", "\145\154\163\145\151\146",
            "\145\154\163\145", "\164\150\145\156", "\164\162\165\145",
            "\146\141\154\163\145", null, null, null, null, "\50", "\51", "\54",
        };
...
/**
     ...
     * @return DOCUMENT ME!
     */
    private final static boolean jjCanMove_0(int hiByte, int i1, int i2,
        long l1, long l2) {
        switch (hiByte) {
        case 0:
     ...
     * @param lexState DOCUMENT ME!
     *
     * @throws TokenMgrError DOCUMENT ME!
     */
...
EOFLoop: 
     ...
     * DOCUMENT ME!
     *
     * @param matchedToken DOCUMENT ME!
     *
     * @throws TokenMgrError DOCUMENT ME!
     */
            ...
            if (jjmatchedPos == -1) {
                if (jjbeenHere[0] &&
                    ...
                    throw new TokenMgrError(("Error: Bailing out of infinite loop caused by repeated empty string matches at line " +
                        input_stream.getBeginLine() + ", column " +
