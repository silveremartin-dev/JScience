...
/**
     ...
     *
     * @param mathML    DOCUMENT ME!
     * @param isLambda  DOCUMENT ME!
     * @param isRatelaw DOCUMENT ME!
     * @throws Exception DOCUMENT ME!
     */
    public MathMLConvertorSAX(String mathML, boolean isLambda, boolean isRatelaw)
        throws Exception {
        ...
        if (isLambda) {
            ...
            } else if (mathML.startsWith("<math:lambda") &&
                    !mathML.endsWith("</math:lambda>")) {
     ...
     */
    public org.jscience.ml.sbml.math.SBMLNode getRoot() {
        return root;
    }
    ...
    public void startElement(String namespaceURI, String localName,
        ...
        try {
            ...
            } else if (qName.equals("math:csymbol") || qName.equals("csymbol") ||
                    qName.equals("/csymbol") || qName.equals("/math:csymbol")) {
                mode = CSYMBOLMODE;

                if (atts.getValue("definitionURL")
                            .equals("http://www.sbml.org/sbml/symbols/time")) {
                    currentNode.setElement(new MathElement("@time"));
                } else if (atts.getValue("definitionURL")
                                   .equals("http://www.sbml.org/sbml/symbols/delay")) {
            ...
            } else if (qName.equals("math:piecewise") ||
                    qName.equals("piecewise")) {
                if (root == null) {
                    root = new SBMLNode(new MathElement()); // the first operator will go here
                    currentNode = root;
                } else { // not the root
            ...
            } else if (qName.equals("math:otherwise") ||
                    qName.equals("otherwise")) {
                SBMLNode n = new SBMLNode(currentNode);
                currentNode.addChild(n);
                currentNode = n; // make this node the current one
            ...
            } else if (qName.equals("math:factorial") ||
                    qName.equals("factorial")) {
            ...
            } else if (qName.equals("math:notanumber") ||
                    qName.equals("notanumber")) {
            ...
            } else if (qName.equals("math:infinity") ||
                    qName.equals("infinity")) {
                currentNode.setElement(new MathElement("@infinity"));
            } else if (qName.equals("math:exponentiale") ||
                    qName.equals("exponentiale")) {
                currentNode.setElement(new MathElement("@exponentiale"));
            } else if (qName.equals("math:semantics") ||
                    qName.equals("semantics")) {
                // throw new Exception("JigCell does not support 'semantics'");
            } else if (qName.equals("math:annotation") ||
                    qName.equals("annotation")) {
                //throw new Exception("JigCell does not support 'annotation'");
            } else if (qName.equals("math:annotation-xml") ||
                    qName.equals("annotation-xml")) {
...
/**
         * Creates a new MyErrorHandler object.
         *
