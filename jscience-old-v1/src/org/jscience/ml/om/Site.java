 ...
 * A site can be identified by its latitude and longitude values, but as for
 * processing reasons this class has some more mandatory fields, such as e.g.
    ...
    public Site(Node site) throws SchemaException, IllegalArgumentException {
        if (site == null) {
            throw new IllegalArgumentException(
                "Parameter site node cannot be NULL. ");
        }
        ...
        if (children != null) {
            if (children.getLength() == 1) {
                ...
                if (child != null) {
                    ...
                    this.setElevation(Float.parseFloat(elevation));
                } else {
                    throw new SchemaException(
                        "Problem while retrieving elevation from site. ");
                }
            } else if (children.getLength() > 1) {
                throw new SchemaException(
                    "Site can have only one elevation level. ");
            }
        }
        ...
        if (children != null) {
            if (children.getLength() == 1) {
                ...
                if (child != null) {
                    ...
                    throw new SchemaException(
                        "Problem while retrieving IAU code from site. ");
                }
            } else if (children.getLength() > 1) {
...
/**
     ...
     */
    public Site(String name, Angle longitude, Angle latitude, int timezone)
     ...
     * Checks if this Site and the given Object are equal. The given object is
     * equal with this Site, if it derives from ISite and if its name,
     * longitude, latitude and elevation equals this Sites name, longitude,
     * latitude and elevation.<br>
     *
     * @param obj The Object to compare this Site with.
     *
     * @return <code>true</code> if the given Object is an instance of ISite
     *         and its name, longitude, latitude and elevation is equal to
     *         this Sites name, longitude, latitude and elevation.<br>
     *         *  (Name comparism is <b>not</b> casesensitive)
     *
     * @see java.lang.Object
     */
    public boolean equals(Object obj) {
        if ((obj == null) || !(obj instanceof ISite)) {
            return false;
        }
    ...
    public Element addToXmlElement(Element element) {
        ...
        if (!Float.isNaN(this.elevation)) {
            ...
            Node n_ElevationText = ownerDoc.createTextNode(String.valueOf(
                        this.elevation));
        ...
        Node n_TimezoneText = ownerDoc.createTextNode(Integer.toString(
                    this.timezone));
