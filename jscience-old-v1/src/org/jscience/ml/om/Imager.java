 ...
 * of org.jscience.ml.om.IImager.<br>
    ...
    public Imager(Node imager) throws SchemaException, IllegalArgumentException {
        if (imager == null) {
            throw new IllegalArgumentException(
                "Parameter imager node cannot be NULL. ");
        }
        ...
        if (child == null) {
            ...
            if (child.getFirstChild() != null) {
                ...
                throw new SchemaException(
                    "Imager cannot have an empty model name. ");
            }
        }
        ...
        if (children != null) {
            if (children.getLength() == 1) {
                ...
                if (child != null) {
                    ...
                    throw new SchemaException(
                        "Problem while retrieving vendor from imager. ");
                }
        ...
        if (children != null) {
            if (children.getLength() == 1) {
                ...
                if (child != null) {
                    ...
                    throw new SchemaException(
                        "Problem while retrieving type from imager. ");
                }
            } else if (children.getLength() > 1) {
        ...
        if (children != null) {
            if (children.getLength() == 1) {
                ...
                if (child != null) {
                    ...
                    throw new SchemaException(
                        "Problem while retrieving remarks from imager. ");
                }
            } else if (children.getLength() > 1) {
                throw new SchemaException(
                    "Imager can have only one remark element. ");
            }
        }
    }
...
/**
     ...
     * Checks if this imager and the given Object are equal. The given object
     * is equal with this Imager is model, type and vendor are equal.<br>
     *
    ...
    public boolean equals(Object obj) {
        if ((obj == null) || !(obj instanceof IImager)) {
            return false;
        }
    ...
    // -------------------------------------------------------------------		
    /**
     * Adds this IImager to a given parent XML DOM Element. The IImager
     * element will be set as a child element of the passed element.
     *
     * @param element The parent element for this IImager
     *
     * @return Returns the element given as parameter with this IImager as
     *         child element.<br>
    ...
    // -------------------------------------------------------------------
    /**
     * Adds the imager link to an given XML DOM Element The IImager
     * element itself will be attached to given elements ownerDocument. If the
     * ownerDocument has no IImager container, it will be created.<br>
     * Example:<br>
     * &lt;parameterElement&gt;<br>
     ...
     * <i>imager description goes
     * here</i><br><b>&lt;/imager&gt;</b><br><b>&lt;/imagerContainer&gt;</b><br><br>
     *
     * @param parent The element under which the the imager link is created
     *
     * @return Returns the Element given as parameter with a additional imager
     *         link, and the imager element under the imager container of the
     *         ownerDocument Might return <code>null</code> if element was
     *         <code>null</code>.
     *
     * @see org.w3c.dom.Element
     */
    public Element addAsLinkToXmlElement(Element parent) {
        if (parent == null) {
            return null;
        }
 ...
 *
     ...
     *
     * @return Returns the vendor name of this imager or <code>NULL</code> if
     *         vendor name was not set.<br>
     *         *
     */
     ...
     * - IImager.Film<br>
     *
     * @return Returns the type imager or <code>NULL</code> if type was not set.<br>
     *         *
     */
     ...
     *
     * @return Returns the remarks to this imager or <code>NULL</code> if no
     *         remarks were set.<br>
     *         *
     */
     ...
     *
     * @throws IllegalArgumentException if new modelname is <code>null</code>
     *         or empty string
     */
    public void setModel(String modelname) throws IllegalArgumentException {
        if ((modelname == null) || ("".equals(modelname))) {
            throw new IllegalArgumentException(
                "Model name cannot be NULL or empty string.S\n");
        }
    ...
    public void setType(String type) {
        if ((IImager.CCD.equals(type)) || (IImager.FILM.equals(type))) {
            this.type = type;
        } else {
            throw new IllegalArgumentException(
                "Imager type must be IImager.CCD or IImager.Film.\n");
        }
    }
    ...
    // -------------------------------------------------------------------
    /**
     * Creates an XML DOM Element for the Imager. The new Imager
     * element will be added as child element to an given parent element. The
     * given parent element should be the target container. All specialised
     * subclasses may use this method to create a Imager element under which
     * they may store their addition data.<br>
     * Example:<br>
     * &lt;imagerContainer&gt;<br>
     * &lt;imager&gt;<br>
     ...
     *         passed container element) Might return <code>null</code> if
     *         parent was <code>null</code>.
     *
     * @see org.w3c.dom.Element
     */
    protected Element createXmlImagerElement(Element parent) {
        ...
        e_Imager.setAttribute(ISchemaElement.XML_ELEMENT_ATTRIBUTE_ID,
            super.getID());
        ...
        if (this.remarks != null) {
            ...
            Node n_RemarksText = ownerDoc.createTextNode(this.remarks);
