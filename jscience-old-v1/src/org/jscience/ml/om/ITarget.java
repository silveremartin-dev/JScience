...
public interface ITarget extends ISchemaElement, IExtendableSchemaElement {
     ...
     * Example:<br>
     * &lt;target xsi:type="fgca:deepSkyGX"&gt;<i>More stuff goes
     * here</i>&lt;/target&gt;
     */
     ...
     * Example:<br>
     * &lt;target&gt; <br>
     * <i>More stuff goes here</i> &lt;name&gt;<code>Target name goes
     * here</code>&lt;/name&gt; <i>More stuff goes here</i> &lt;/target&gt;
     */
     ...
     * &lt;target&gt; <br>
     * <i>More stuff goes here</i> &lt;name&gt;<code>Target name goes
     * here</code>&lt;/name&gt; &lt;alias&gt;<code>Target alias name goes
     * here</code>&lt;/alias&gt; <i>More stuff goes here</i> &lt;/target&gt;
     */
    public static final String XML_ELEMENT_ALIASNAME = "alias";

    /**
     * Constant for XML representation: Celestial constellation where
     * the target can be found.<br>
     * Example:<br>
     * &lt;target&gt; <br>
     * <i>More stuff goes here</i> &lt;constellation&gt;<code>Constellationname
     * goes here</code>&lt;/constellation&gt; <i>More stuff goes here</i>
     * &lt;/target&gt;
     */
    public static final String XML_ELEMENT_CONSTELLATION = "constellation";

    /**
     * Constant for XML representation: Datasource that is the origin
     * of this target.<br>
     * Whether the datasource is given, or a observer is referenced. Example:<br>
     * &lt;target&gt; <br>
     * <i>More stuff goes here</i> &lt;datasource&gt;<code>Datasource goes
     * here</code>&lt;/datasource&gt; <i>More stuff goes here</i>
     * &lt;/target&gt;
     */
    ...
    // -------------------------------------------------------------------
    /**
     * Adds this Target to a given parent XML DOM Element. The Target
     * element will be set as a child element of the passed element.
     *
     * @param element The parent element for this Target
     *
     * @return Returns the element given as parameter with this Target as child element.<br>
    ...
    // -------------------------------------------------------------------
    /**
     * Adds the target link to an given XML DOM Element The target
     * element itself will be attached to given elements ownerDocument. If the
     * ownerDocument has no target container, it will be created.<br>
     * Example:<br>
     * &lt;parameterElement&gt;<br>
     ...
     * <i>target description goes
     * here</i><br><b>&lt;/target&gt;</b><br><b>&lt;/targetContainer&gt;</b><br><br>
     *
     * @param parent The element under which the the target link is created
     *
     * @return Returns the Element given as parameter with a additional target
     *         link, and the target element under the target container of the
     ...
     *
     * @return Returns <code>true</code> if the alias name could be added to
     *         the target.
     */
     ...
     * without deleting the existing ones, please use
     * Target.addAliasNames(String) or Target.addAliasName(String).<br>
     ...
     *
     * @return Returns <code>true</code> if the alias name could be removed
     *         from the target. If <code>false</code> is returned the given
     *         alias name could not be found in the targets alias name list.
     */
    ...
    // -------------------------------------------------------------------
    /**
     * Sets the celestial constellation, where the target can be
     * found.<br>
     *
     ...
     *
     * @return Returns a String array with all alias names. If no alias names
     *         were set <code>null</code> is returned.
     */
     ...
     * The name should clearly identify the astronomical object. Use alias
     * names for colloquial names of the object.
     *
     ...
     * The name should clearly identify the astronomical object. For
     * alternative names of the object add a new alias name.<br>
     * If a name is already set to the target, the old name will be
     * overwritten with new new name.
     *
     ...
     * The position of the target describes the location of the astronomical
     * object in any popular celestial coordination system.
     *
     ...
     * The position of the target describes the location of the astronomical
     * object in a popular celestial coordination system.
     *
