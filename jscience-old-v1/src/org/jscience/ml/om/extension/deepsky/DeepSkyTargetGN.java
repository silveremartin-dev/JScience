...
/**
 * DeepSkyTargetGN extends the org.jscience.ml.om.extension.deepsky.DeepSkyTarget class.<br>
...
public class DeepSkyTargetGN extends DeepSkyTarget {
    ...
    // class
    private static final String XML_XSI_TYPE_VALUE = "fgca:deepSkyGN";
    ...
    /**
     * Constructs a new instance of a DeepSkyTargetGN from a given DOM
     * target Element.<br>
     ...
     */
    public DeepSkyTargetGN(Node targetElement,
                           IObserver[] observers)
        ...
        children = target.getElementsByTagName(DeepSkyTargetGN.XML_ELEMENT_POSITIONANGLE);
        if (children != null) {
    ...
    // -------------------------------------------------------------------
    /**
     * Returns the nebula type.
     * Nebular type might be something like e.g. emission, reflection, dark nebula
     *
     * @return The nebula type as String
    ...
    // -------------------------------------------------------------------
    /**
     * Sets the large axis position angle of the galactic nebula.
    ...
    // -------------------------------------------------------------------
    /**
     * Sets the nebula type.
     * E.g. emission, reflection, dark nebula...
     *
     * @param newNebulaType The new nebula type
     */
    public void setNebulaType(String newNebulaType) {

        if ((newNebulaType != null)
                && ("".equals(newNebulaType.trim()))
                ) {
