...
/**
 * DeepSkyTargetGC extends the org.jscience.ml.om.extension.deepsky.DeepSkyTarget class.<br>
 * Its specialised for galactic clusters.<br>
 *
...
public class DeepSkyTargetGC extends DeepSkyTarget {
    ...
    // class
    private static final String XML_XSI_TYPE_VALUE = "fgca:deepSkyGC";
    ...
    /**
     * Constructs a new instance of a DeepSkyTargetGC from a given DOM
     * target Element.<br>
     ...
     */
    public DeepSkyTargetGC(Node targetElement,
                           IObserver[] observers)
    ...
    public Element addToXmlElement(Element element) {
        ...
        Element e_DSTarget = super.createXmlDeepSkyTargetElement(element, DeepSkyTargetGC.XML_XSI_TYPE_VALUE);
     ...
     *
     * @return The magnitude of the stars in the galactic cluster.
     ...
     *
     * @param newConcentration The new concentration of the stars in the
     *                         galactic cluster
     */
    public void setConcentration(String newConcentration) {

        if ((newConcentration != null)
                && ("".equals(newConcentration.trim()))
                ) {
     ...
     *
     * @param newMagnitude The new magnitude of the stars in the galactic
     *                     cluster
     */
