...
/**
 * DeepSkyTargetPN extends the org.jscience.ml.om.extension.deepsky.DeepSkyTarget class.<br>
...
public class DeepSkyTargetPN extends DeepSkyTarget {
    ...
    // class
    private static final String XML_XSI_TYPE_VALUE = "fgca:deepSkyPN";
    ...
    /**
     * Constructs a new instance of a DeepSkyTargetPN from a given DOM
     * target Element.<br>
     ...
     */
    public DeepSkyTargetPN(Node targetElement,
                           IObserver[] observers)
    ...
    public Element addToXmlElement(Element element) {
        ...
        Element e_DSTarget = super.createXmlDeepSkyTargetElement(element, DeepSkyTargetPN.XML_XSI_TYPE_VALUE);
     ...
     *
     * @return The magnitude of the central star
