...
/**
 * DeepSkyTargetDN extends the org.jscience.ml.om.extension.deepsky.DeepSkyTarget class.<br>
...
public class DeepSkyTargetDN extends DeepSkyTarget {
    ...
    // class
    private static final String XML_XSI_TYPE_VALUE = "fgca:deepSkyDN";
    ...
    /**
     * Constructs a new instance of a DeepSkyTargetDN from a given DOM
     * target Element.<br>
     ...
     */
    public DeepSkyTargetDN(Node targetElement,
                           IObserver[] observers)
    ...
    public Element addToXmlElement(Element element) {
        ...
        Element e_DSTarget = super.createXmlDeepSkyTargetElement(element, DeepSkyTargetDN.XML_XSI_TYPE_VALUE);
    ...
    // -------------------------------------------------------------------
    /**
     * Returns the opacity of the dark nebula.
     * After Lynds: 1=min; 6=max
     *
     * @return The opacity of the dark nebula as integer between 1-6
     *         The returned value might be <code>-1</code> if the value was never set
     */
    ...
    // -------------------------------------------------------------------
    /**
     * Sets the position angle of the large axis of the dark nebula.
    ...
    // -------------------------------------------------------------------
    /**
     * Sets the opacity of the dark nebula.
     * The opacity value has to be between 1 and 6.
     * (After Lynds: 1=min; 6=max)<br>
     * All other values will
     * be interpreted as -1, which means that the value gets cleared
     * (means: is treated like it was never set)
     *
