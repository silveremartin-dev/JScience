...
import org.jscience.ml.om.Finding;
import org.jscience.ml.om.IFinding;
...
public class DeepSkyFinding extends Finding {
    ...
    // class
    private static final String XML_XSI_TYPE_VALUE = "fgca:findingsDeepSkyType";
     ...
     * A valid rating value is an integer between 1 and 7 (including 1 and 7).
     ...
     *               A valid rating value is an integer between 1 and 7
     * @throws IllegalArgumentException if rating > 7 or < 1
     */
    public void setRating(int rating) throws IllegalArgumentException {

        if ((rating > 7) || (rating < 1)) {
            throw new IllegalArgumentException("Rating value cannot be smaller then 1 or greater then 7. ");
        }
    ...
    public boolean setSmallDiameter(Angle smallDiameter) {
        ...
        if ((smallDiameter == null) || (smallDiameter.getValue() < 0.0f)) {
            return false;
        }
