...
public abstract class DeepSkyTarget extends Target {
    ...
    // The astronomical objects surface brightness in magnitudes per squareminute
    // (Float.NaN indicates that field was not set)
    private float surfaceBrightness = Float.NaN;
    ...
    /**
     * Constructs a new instance of a DeepSkyTarget from a given DOM
     * target Element.<br>
     ...
     */
    protected DeepSkyTarget(Node targetElement,
        ...
        if (children != null) {
            if (children.getLength() == 1) {
                ...
                this.setVisibleMagnitude(Float.parseFloat(visMag));
            } else if (children.getLength() > 1) {
        ...
        if (children != null) {
            if (children.getLength() == 1) {
                ...
                this.setSurfaceBrightness(Float.parseFloat(surBright));
            } else if (children.getLength() > 1) {
     ...
     */
    protected DeepSkyTarget(String name,
                            String datasource) {
    ...
    public String toString() {
        ...
        if (super.getAliasNames().length > 0) {
     ...
     * Checks if this DeepSkyTarget and the given Object are equal. The given
     * object is equal with this DeepSkyTarget, if it derives from ITarget,
     * both XSI types are equal and its name equals this DeepSkyTargets name.<br>
     *
     * @param obj The Object to compare this DeepSkyTarget with.
     * @return <code>true</code> if the given Object is an instance of ITarget,
     *         both XSI types are equal and its name is equal to this DeepSkyTargets name.<br>
     ...
     * @see org.w3c.dom.Element
     */
    protected Element createXmlDeepSkyTargetElement(Element element, String xsiType) {
        ...
        if (largeDiameter != null) {
            ...
            e_LargeDiameter = smallDiameter.setToXmlElement(e_LargeDiameter);
        ...
        if (!Float.isNaN(surfaceBrightness)) {
            Element e_SurfBr = ownerDoc.createElement(XML_ELEMENT_SURFACEBRIGHTNESS);
            Node n_SurfBrText = ownerDoc.createTextNode(Float.toString(this.getSurfaceBrightness()));
            e_SurfBr.appendChild(n_SurfBrText);
     ...
     *
     * @return The large diameter of the astronomical object as Angle
     *         The returned value might be <code>null</code> if the value was never set
     ...
     *
     * @return The small diameter of the astronomical object as Angle
     *         The returned value might be <code>null</code> if the value was never set
     * @see org.jscience.ml.om.Angle
     */
     ...
     * in magnitudes per squareminute.
     *
     ...
     * A valid Angle has a value larger (or euqals) 0.0.
     *
     * @param largeDiameter The large diameter to set
     * @return boolean <b>true</b> if the large diameter could be set.
     *         If <b>false</b> is returned the parameter was
     *         <code>null</code> or had a negative value.
     */
    public boolean setLargeDiameter(Angle largeDiameter) {

        if ((largeDiameter == null)
                || (largeDiameter.getValue() < 0.0)
                ) {
            return false;
        }
     ...
     * A valid Angle has a value larger (or euqals) 0.0.
     *
     * @param smallDiameter The small diameter to set
     * @return boolean <b>true</b> if the small diameter could be set.
     *         If <b>false</b> is returned the parameter was
     *         <code>null</code> or had a negative value.
     */
     ...
     *
     * @param surfaceBrightness The surface brightness to set
     */
     ...
     *
     * @param visibleMagnitude The visible magnitude to set
     */
