...
public abstract class SolarSystemTarget extends Target {
     ...
     * Checks if this SolarSystemTarget and the given Object are equal. The given
     * object is equal with this DeepSkyTarget, if it derives from ITarget,
     * both XSI types are equal and its name equals this SolarSystemTarget name.<br>
     *
     * @param obj The Object to compare this SolarSystemTarget with.
     * @return <code>true</code> if the given Object is an instance of ITarget,
     *         both XSI types are equal and its name is equal to this SolarSystemTarget name.<br>
