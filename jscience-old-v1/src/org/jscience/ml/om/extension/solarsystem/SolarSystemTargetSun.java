...
/**
 * SolarSystemTargetSun extends the
...
public class SolarSystemTargetSun extends SolarSystemTarget {
    ...
    // class
    private static final String XML_XSI_TYPE_VALUE = "fgca:SunTargetType";
    ...
    /**
     * Constructs a new instance of a SolarSystemTargetSun from a given DOM
     * target Element.<br>
     ...
     */
    public SolarSystemTargetSun(Node targetElement,
     ...
     */
    public SolarSystemTargetSun(String name,
