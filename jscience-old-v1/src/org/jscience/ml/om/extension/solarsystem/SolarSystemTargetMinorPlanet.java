...
public class SolarSystemTargetMinorPlanet extends SolarSystemTarget {
    ...
    // class
    private static final String XML_XSI_TYPE_VALUE = "fgca:MinorPlanetTargetType";
    ...
    /**
     * Constructs a new instance of a SolarSystemTargetMinorPlanet from a given DOM
     * target Element.<br>
     ...
     */
    public SolarSystemTargetMinorPlanet(Node targetElement,
     ...
     */
    public SolarSystemTargetMinorPlanet(String name,
    ...
    public Element addToXmlElement(Element element) {
        ...
        super.createXmlSolarSystemTargetElement(element, SolarSystemTargetMinorPlanet.XML_XSI_TYPE_VALUE);
