...
public class UnitModelTests extends SBMLModelTests {
    ...
    public void testReaction1() throws Exception {
        Reaction reaction = testReaction("v1", false, true);
    ...
    public void testReaction2() throws Exception {
        Reaction reaction = testReaction("v2", false, true);
        assertTrue(reaction.getReactant().size() == 1);
    ...
    public void testReaction3() throws Exception {
        Reaction reaction = testReaction("v3", false, true);
        assertTrue(reaction.getReactant().size() == 1);
    ...
    protected void setUp() throws Exception {
        model = SBMLLevel2Reader.read(new InputStreamReader(EventModelTests.class.getResourceAsStream("l2v1-units.sbml")));
    }
}
