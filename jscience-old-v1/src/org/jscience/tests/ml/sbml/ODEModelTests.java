...
public class ODEModelTests extends SBMLModelTests {
    ...
    public void testCompartment1() throws Exception {
        testCompartment("V0", true, null, 10.0, 3, null);
    }
    ...
    public void testCompartment2() throws Exception {
        testCompartment("V1", false, null, 1.0, 3, null);
    }
    ...
    public void testReaction4() throws Exception {
        Reaction reaction = testReaction("reaction_4", false, false);
        assertTrue(reaction.getReactant().size() == 1);
    ...
    protected void setUp() throws Exception {
        model = SBMLLevel2Reader.read(new InputStreamReader(EventModelTests.class.getResourceAsStream("l2v1-mc-ode.sbml")));
    }
}
