 ...
 */
public class ClassicalRungeKuttaIntegratorTest extends TestCase {
/**
     * Creates a new ClassicalRungeKuttaIntegratorTest object.
     *
    ...
    public void testDimensionCheck() {
        try {
            ...
            new ClassicalRungeKuttaIntegrator(0.01).integrate(pb, 0.0,
    ...
    public void testNullIntervalCheck() {
        try {
            TestProblem1 pb = new TestProblem1();
            new ClassicalRungeKuttaIntegrator(0.01).integrate(pb, 0.0,
                new double[pb.getDimension()], 0.0,
