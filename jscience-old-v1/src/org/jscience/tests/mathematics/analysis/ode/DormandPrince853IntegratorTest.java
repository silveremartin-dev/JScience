 ...
 */
public class DormandPrince853IntegratorTest extends TestCase {
/**
     * Creates a new DormandPrince853IntegratorTest object.
     *
    ...
    public void testDimensionCheck() {
        try {
            ...
            DormandPrince853Integrator integrator = new DormandPrince853Integrator(0.0,
                    1.0, 1.0e-10, 1.0e-10);
    ...
    public void testNoDenseOutput()
        ...
        integ.integrate(pb1, pb1.getInitialTime(), pb1.getInitialState(),
        ...
        integ.integrate(pb2, pb2.getInitialTime(), pb2.getInitialState(),
