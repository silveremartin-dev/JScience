...
/**
 * Signals that the substitution matrix does not comply with the
 * specification (see {@linkPlain ScoringMatrix} for details).
 *
...
/**
     * Constructs an <CODE>InvalidScoringMatrixException</CODE> with null as
...
/**
     * Constructs an <CODE>InvalidScoringMatrixException</CODE> with the
