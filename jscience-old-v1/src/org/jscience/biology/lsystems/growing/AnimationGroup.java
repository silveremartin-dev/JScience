...
public class AnimationGroup implements Comparable {
    ...
    /**
     * The transformgroup where to make the translation of the subtree
     * following the scaled element.
     */
    public TransformGroup m_tgTrans;

/**
     * Constructor for leafs. Leafs only have a scale transformgroup so this
     * constructor can be used. Also start and end time of animation are
     * needed.
     *
     * @param fStartTime The time when to start the animation.
     * @param fEndTime   The time when to stop the animation.
     * @param tgScale    The transformgroup of the shape which has to be scaled.
     */
    public AnimationGroup(float fStartTime, float fEndTime,
...
/**
     ...
     * @param fEndTime   The time when to stop the animation.
     * @param tgScale    The transformgroup of the shape which has to be scaled.
     * @param tgTrans    The transformgroup for the translation of the subtree.
     */
    public AnimationGroup(float fStartTime, float fEndTime,
        TransformGroup tgScale, TransformGroup tgTrans) {
    ...
    /**
     * Override this method for the comparable interface which is used
     * to sort the list.
     *
    ...
    public int compareTo(Object obj) {
        if (obj instanceof AnimationGroup == false) {
            //Log.log("Wrong type of object. Must be instace of Animationgroup");
            return 0;
        }
