...
/**
 * A class representing the Glutamine molecule.
 *
 * @author Silvere Martin-Michiellot
 * @version 1.0
 */
public final class Glutamine extends AminoAcid {
    /** DOCUMENT ME! */
    ...
    static {
        ...
        bond16 = new Bond(carbonAtom5, oxygenAtom3, Bond.DOUBLE);
        bond17 = new Bond(carbonAtom5, nitrogenAtom2);
        bond18 = new Bond(nitrogenAtom2, hydrogenAtom9);
        bond19 = new Bond(nitrogenAtom2, hydrogenAtom10);
    }

/**
     * Creates a new Glutamine object.
     */
    public Glutamine() {
        super(carbonAtom1, "Glutamine");
    }
}
