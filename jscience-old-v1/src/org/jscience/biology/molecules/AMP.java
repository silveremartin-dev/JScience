...
public final class AMP extends Molecule {
    /** DOCUMENT ME! */
    ...
    static {
        ...
        bond33 = new Bond(oxygenAtom3, carbonAtom5);

        //phosphate
        bond34 = new Bond(phosphorusAtom, oxygenAtom4);
        bond35 = new Bond(phosphorusAtom, oxygenAtom5);

        //bond36 = new Bond(oxygenAtom5, hydrogenAtom13);
        bond37 = new Bond(phosphorusAtom, oxygenAtom6, Bond.DOUBLE);
        bond38 = new Bond(phosphorusAtom, oxygenAtom7);

        //bond39 = new Bond(oxygenAtom7, hydrogenAtom14);
        oxygenAtom5.setCharge(-1);
        oxygenAtom7.setCharge(-1);
    }
