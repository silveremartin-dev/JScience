...
/**
 * A class representing the Lactose carbohydrate molecule.
 *
 * @author Silvere Martin-Michiellot
 * @version 1.0
 */
public final class Lactose extends Molecule {
    /** DOCUMENT ME! */
    ...
    static {
        ...
        bond6 = new Bond(carbonAtom2, oxygenAtom2);
        bond7 = new Bond(oxygenAtom2, hydrogenAtom4);
        bond8 = new Bond(carbonAtom2, carbonAtom3);
        bond9 = new Bond(carbonAtom3, oxygenAtom3);
        bond10 = new Bond(oxygenAtom3, hydrogenAtom5);
        ...
        bond16 = new Bond(carbonAtom5, oxygenAtom5);
        bond17 = new Bond(oxygenAtom5, carbonAtom1);
        bond18 = new Bond(carbonAtom5, carbonAtom6);
        bond19 = new Bond(carbonAtom6, hydrogenAtom9);
        bond20 = new Bond(carbonAtom6, hydrogenAtom10);
        bond21 = new Bond(carbonAtom6, oxygenAtom6);
        bond22 = new Bond(oxygenAtom6, hydrogenAtom11);

        //bond to other ose
        bond23 = new Bond(carbonAtom4, oxygenAtom4);
        bond24 = new Bond(oxygenAtom4, carbonAtom7);

        bond25 = new Bond(carbonAtom7, hydrogenAtom12);
        bond26 = new Bond(carbonAtom7, carbonAtom8);
        bond27 = new Bond(carbonAtom8, hydrogenAtom13);
        bond28 = new Bond(carbonAtom8, oxygenAtom7);
        bond29 = new Bond(oxygenAtom7, hydrogenAtom14);
        bond30 = new Bond(carbonAtom8, carbonAtom9);
        bond31 = new Bond(carbonAtom9, oxygenAtom8);
        bond32 = new Bond(oxygenAtom8, hydrogenAtom15);
        bond33 = new Bond(carbonAtom9, hydrogenAtom16);
        bond34 = new Bond(carbonAtom9, carbonAtom10);
        bond35 = new Bond(carbonAtom10, oxygenAtom9);
        bond36 = new Bond(oxygenAtom9, hydrogenAtom17);
        bond37 = new Bond(carbonAtom10, hydrogenAtom18);
        bond38 = new Bond(carbonAtom10, carbonAtom11);
        bond39 = new Bond(carbonAtom11, hydrogenAtom19);
        bond40 = new Bond(carbonAtom11, oxygenAtom10);
        bond41 = new Bond(oxygenAtom10, carbonAtom7);
        bond42 = new Bond(carbonAtom11, carbonAtom12);
        bond43 = new Bond(carbonAtom12, hydrogenAtom20);
        bond44 = new Bond(carbonAtom12, hydrogenAtom21);
        bond45 = new Bond(carbonAtom12, oxygenAtom11);
        bond46 = new Bond(oxygenAtom11, hydrogenAtom22);
    }

/**
     * Creates a new Lactose object.
     */
    public Lactose() {
        super(carbonAtom1);
    }
