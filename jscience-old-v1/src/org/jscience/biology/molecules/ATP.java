...
public final class ATP extends Molecule {
    /** DOCUMENT ME! */
    ...
    /** DOCUMENT ME! */
    private static Atom phosphorusAtom3;
    ...
    static {
        ...
        phosphorusAtom3 = new Atom(phosphorusElement);
        ...
        bond44 = new Bond(oxygenAtom10, phosphorusAtom3);
        bond45 = new Bond(phosphorusAtom3, oxygenAtom11);

        //bond46 = new Bond(oxygenAtom11, hydrogenAtom15);
        bond47 = new Bond(phosphorusAtom3, oxygenAtom12, Bond.DOUBLE);
        bond48 = new Bond(phosphorusAtom3, oxygenAtom13);

        //bond49 = new Bond(oxygenAtom13, hydrogenAtom16);
        oxygenAtom5.setCharge(-1);
        oxygenAtom8.setCharge(-1);
        oxygenAtom11.setCharge(-1);
