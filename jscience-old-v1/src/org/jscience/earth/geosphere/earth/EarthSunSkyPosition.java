 ...
 * book, the epoch is 1990 January 0.0.
 * <p/>
...
//currently redeveloped from class SunPosition from OpenBBN distributed under the following license http://openmap.bbn.com/license.html

public class EarthSunSkyPosition {
    ...
    /**
     * Constant denoting the number of radians an object would
     * travel if it orbited around the earth in a day.
     */
    ...
    public static LatLonPoint sunPosition(long mssue) {
        ...
        double tmpAscension = sunAscension -
                (TWO_PI / 24) * greenwichSiderealTime(julianDate, cal);
     ...
     * like it works, but I don't have anything to test it against.
     * No promises.
     *
     * @param mssue milliseconds since unix epoch
     * @return LatLonPoint of the point on the earth that is closest.
    ...
    /**
     * Little function that resets the input to be within 0 - 2*PI,
     * by adding or subtracting 2PI as needed.
     *
