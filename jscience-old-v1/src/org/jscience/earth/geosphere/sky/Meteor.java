...
/**
 * Describes the collision of an artificial satellite, asteroid or a comet (of
 * small size) on the Virtual Planet
 */
...
//this is for small meteors that don't do major explosions,
/**
 * DOCUMENT ME!
 *
 * @author $author$
 * @version $Revision: 1.3 $
  */
public class Meteor extends ClimaticEvent {
/**
     * Creates a new Meteor object.
     *
     ...
     */
    public Meteor(long time, Transform3D position, Bounds bounds,
