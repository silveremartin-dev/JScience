...
/**
 * Describes the climatic event of the same name, aurora borealis
 */
...
//Seen at poles and also on some moons of the solar system
/**
 * DOCUMENT ME!
 *
 * @author $author$
 * @version $Revision: 1.3 $
  */
public class Aurora extends ClimaticEvent {
/**
     * Creates a new Aurora object.
     *
     ...
     */
    public Aurora(long time, Transform3D position, Bounds bounds,
