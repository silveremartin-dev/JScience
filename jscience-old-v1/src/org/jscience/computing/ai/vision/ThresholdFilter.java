...
public class ThresholdFilter extends Filter {
     ...
     * create a grouping of pixels that approximates the pixel group
     * brightness.
     */
     ...
     * diffusing it across an area. This is the best thresholding algorithms
     * for photographs and other complicated images.
     */
    ...
    /**
     * Sets the threshold limit used by one- or two-point thresholding. For
     * one- point thresholding it is the primary threshold point. For
     * two-point thresholding, it specifies the lower threshold limit.
     *
    ...
    protected BufferedImage patternDiffusion(BufferedImage image,
        ...
        int[] dither = {
                0, 128, 32, 160, 192, 64, 224, 96, 48, 176, 16, 144, 240, 112,
                208, 80
        };
