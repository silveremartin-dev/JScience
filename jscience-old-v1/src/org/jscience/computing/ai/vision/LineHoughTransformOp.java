...
/**
 * This class implements a Line Hough transform. It is heavily based on
 * code written by Timothy Sharman for the excellent HIPR2 resource site
...
/**
    ...
    /**
     * Returns the accumulator as an image. Values are scaled linearly
    ...
    /**
     * Runs the line Hough Transform. Note that the input image must be
     * an edge-only, greyscale image (ie, must have been passed through an
     * edge detector and thresholding filter).
     *
    ...
    /**
     * Returns the superimposed image. This can be a full-colour
     * version of the image the Hough transform has been run on.
     *
     ...
     * @param i DOCUMENT ME!
     * @param j DOCUMENT ME!
     * @param hw DOCUMENT ME!
     * @param hh DOCUMENT ME!
     * @param neighbourhood DOCUMENT ME!
     *
     * @return DOCUMENT ME!
     */
    ...
    public static void main(String[] args) {
        if (args.length < 1) {
            System.err.println(
                "usage: java LineHoughTransform <input> {acc-threshold} {local-peak}");
        ...
        try {
            ...
            javax.imageio.ImageIO.write(in2, "png",
                new java.io.File("houghSobel.png"));
            javax.imageio.ImageIO.write(in3, "png",
                new java.io.File("houghInput.png"));
