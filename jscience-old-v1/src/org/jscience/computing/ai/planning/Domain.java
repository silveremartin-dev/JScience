...
public abstract class Domain {
    ...
    /**
     * The <code>String</code> names of compound tasks that appear in
     * the domain description. These <code>String</code>s are only used to
    ...
    /**
     * The <code>String</code> names of constant symbols that appear in
     * the domain description. These <code>String</code>s are only used to
    ...
    /**
     * The methods in this domain. The array is indexed by first the
     * compound task each method can decompose, and second the order the
     * methods that decompose the same compound task appear in the domain
     * description.
     */
    protected Method[][] methods;

    /**
     * The operators in this domain. The array is indexed by first the
     * primitive task each operator can achieve, and second the order the
     * operators that achieve the same primitive task appear in the domain
     * description.
     */
    protected Operator[][] ops;

    /**
     * The <code>String</code> names of primitive tasks that appear in
     * the domain description. These <code>String</code>s are only used to
    ...
    /**
     * The <code>String</code> names of constant symbols that appear in
     * the problem description. These <code>String</code>s are only used to
     * print the constant symbols, since the constant symbols are mapped to
     * integers at compile time. The same integers are used to index this
     * array.
     */
     ...
     *
     * @param idx the integer equivalent of the constant symbol.
     *
    ...
    /**
     * This function returns an array of the <code>String</code>
     ...
     *
     * @return the array of <code>String</code> representations of the
    ...
    /**
     * This function sets the array of <code>String</code>
     ...
     *
     * @param inp the array of <code>String</code> representations of constant
     *        symbols.
     */
