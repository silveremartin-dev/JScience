...
/**
    ...
    /**
     * To append another term to the end of this list. Note that this
     * function is destructive, i.e., it appends the given term to this list,
    ...
    /**
     * To apply a given binding to this list. Note that this function
     * does NOT change this list, rather, it creates a new list which is the
     * result of binding.
     *
    ...
    /**
     * To get the tail of this list as another list, assuming that the
     * tail is indeed a list.
     *
    ...
    /**
     * This function gets a <code>LinkedList</code> of terms as input
     * and returns a list the elements of which are the terms in the input
    ...
    /**
     * This function is used at compile time to produce Java code that
     * when run, will create this list.
     *
     * @return DOCUMENT ME!
     */
