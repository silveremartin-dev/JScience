...
/**
     ...
     *
     * @param listIn the list this term represents.
     */
...
/**
     * To initialize this list term.
     *
     * @param headIn the head of the list this term represents.
     * @param tailIn the tail of the list this term represents.
     */
     ...
     *
     * @return the list this term represnts.
     */
    public List getList() {
        return list;
    }
    ...
    /**
     * Whether or not there are any variables in the list this term
     * represents.
     *
     * @return DOCUMENT ME!
     */
     ...
     *
     * @param varCount number of variables in the resulting predicate.
     *
     * @return the resulting predicate.
     */
    public Predicate toPredicate(int varCount) {
        return new Predicate(((TermConstant) list.getHead()).getIndex(),
            varCount, list.getTail());
    }
