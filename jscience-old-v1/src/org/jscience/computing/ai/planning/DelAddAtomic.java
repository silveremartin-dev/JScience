...
/**
     ...
     *
     * @param atomIn the atom to be deleted/added.
     */
    ...
    /**
     * To add this atomic delete/add element to the current state of
     * the world.
     *
     * @param s DOCUMENT ME!
    ...
    /**
     * To delete this atomic delete/add element from the current state
     * of the world.
     *
     * @param s DOCUMENT ME!
     * @param binding DOCUMENT ME!
    ...
    public boolean del(State s, Term[] binding, Vector[] delAddList) {
        ...
        //-- If the resulting atom is protected in the current state of the wolrd,
        ...
        if ((index = s.del(p)) != -1) {
            ...
            //-- the data strucutures should look exactly as they were before the
    ...
    /**
     * To set the number of variables in this atomic delete/add
     * element.
     *
    ...
    /**
     * This function produces Java code to create this atomic
     * delete/add element.
     *
     * @return DOCUMENT ME!
     */
