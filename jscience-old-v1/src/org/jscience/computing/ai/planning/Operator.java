...
public abstract class Operator extends DomainElement {
    ...
    /**
     * Represents the add list in case it is a variable (The integer
     * value represents variable's index), otherwise it is -1.
     */
    ...
    /**
     * Represents the delete list in case it is a real list and not a
     * variable.
     */
    private DelAddElement[] del;

    /**
     * Represents the delete list in case it is a variable (The integer
     * value represents variable's index), otherwise it is -1.
     */
...
/**
     ...
     *
     * @param head        head of the operator.
     * @param delVarIdxIn the index of the delete list as a variable, -1 if the
     *                    delete list is not a variable.
     * @param addVarIdxIn the index of the add list as a variable, -1 if the
     *                    add list is not a variable.
     ...
     * @param s current state of the world.
     * @param delAdd a 4-member array of type <code>Vector</code> used to keep
     ...
     *        undo these changes.
     *
     * @return <code>true</code> if the operator was applicable,
     *         <code>false</code> otherwise. An operator is not applicable
     *         when at least one of the atoms it tries to delete is protected.
     */
     ...
     *
     * @param binding the binding to be applied to the cost term.
     *
     * @return the cost of applying this operator.
     */
