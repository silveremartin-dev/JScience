...
public class InternalAxiom extends InternalElement {
     ...
     * represents a branch of the axiom. Note that we use a
     * <code>Vector</code> rather than an array because at compile time we do
     * not know how many branches a particular axiom will have.
     */
    private Vector branches;

    /**
     * A <code>Vector</code> of <code>String</code>s each of which
     * represents the label of a branch of this axiom.
     */
...
/**
     ...
     * @param branchesIn a <code>Vector</code> of logical expressions each of
     *                   which represents a branch of the axiom.
     * @param labelsIn   a <code>Vector</code> of <code>String</code> labels.
     */
    public InternalAxiom(Predicate head, Vector branchesIn, Vector labelsIn) {
