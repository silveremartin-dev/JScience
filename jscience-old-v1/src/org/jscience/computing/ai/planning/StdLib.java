...
class Div implements Calculate {
     ...
     * dividing the first argument by the second one, the result of that
     * division by the third argument, and so on.
     *
     * @param l DOCUMENT ME!
     *
     * @return DOCUMENT ME!
...
class Equal implements Calculate {
    /**
     * This function executes the code call and returns
     * <code>NIL</code> if not all of its (possibly several) arguments are
     * equal, and something other than <code>NIL</code> otherwise.
     *
     * @param l DOCUMENT ME!
     *
     * @return DOCUMENT ME!
...
class Less implements Calculate {
    /**
     * This function executes the code call and returns something other
     * than <code>NIL</code> if and only if each argument in its argument list
...
class LessEq implements Calculate {
     ...
     * This function executes the code call and returns something other
     * than <code>NIL</code> if and only if each argument in its argument list
     * is less than or equal to the next argument.
     *
     * @param l DOCUMENT ME!
     *
     * @return DOCUMENT ME!
...
class Member implements Calculate {
    /**
     * This function executes the code call and returns
     * <code>NIL</code> if its first argument is not a member of its second
     * argument, and something other than <code>NIL</code> otherwise.
     *
     * @param l DOCUMENT ME!
     *
     * @return DOCUMENT ME!
...
class More implements Calculate {
     ...
     * This function executes the code call and returns something other
     * than <code>NIL</code> if and only if each argument in its argument list
     * is more than the next argument.
     *
     * @param l DOCUMENT ME!
     *
     * @return DOCUMENT ME!
...
class MoreEq implements Calculate {
     ...
     * This function executes the code call and returns something other
     * than <code>NIL</code> if and only if each argument in its argument list
     * is more than or equal to the next argument.
     *
     * @param l DOCUMENT ME!
     *
     * @return DOCUMENT ME!
...
class Mult implements Calculate {
    /**
     * This function executes the code call and returns the product of
     * all its arguments.
     *
     * @param l DOCUMENT ME!
     *
...
class NotEq implements Calculate {
     ...
     * This function executes the code call and returns something other
     * than <code>NIL</code> if and only if each argument in its argument list
     * is not equal to the next argument.
     *
     * @param l DOCUMENT ME!
     *
     * @return DOCUMENT ME!
...
class Plus implements Calculate {
    /**
     * This function executes the code call and returns the sum of all
     * its arguments.
     *
     * @param l DOCUMENT ME!
     *
...
class Power implements Calculate {
    /**
     * This function executes the code call and returns the result by
     * raising the first argument to the power of the second one, the result
     * of that to the power of the third argument, and so on.
     *
     * @param l DOCUMENT ME!
     *
     * @return DOCUMENT ME!
