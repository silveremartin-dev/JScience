...
/**
     ...
     *
     * @param headIn      the task atom itself.
     * @param immediateIn whether or not this task atom is marked
     *                    <code>:immediate</code>.
     * @param primitiveIn whether or not this task atom is a primitive one.
     */
    ...
    /**
     * To calculate the result of applying a given binding to this task
     * atom.
     *
    ...
    public TaskAtom bind(Term[] binding) {
        return new TaskAtom(head.applySubstitution(binding), immediate,
            primitive);
    }
     ...
     *
     * @return the head of this task atom.
     */
     ...
     *
     * @return <code>true</code> if the task atom is marked
     ...
     *
     * @return <code>true</code> if the task atom is primitive,
     ...
     * showing the value of this task atom.
     *
    ...
    public String toString() {
        ...
        if (primitive) {
            s = head.toString(Planner.getDomain().primitiveTasks);
        } else {
            s = head.toString(Planner.getDomain().compoundTasks);
        }
