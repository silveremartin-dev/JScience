...
/**
 * Implements the A algorithm. Pathing can be done on any class that
 * implements the <code>Navigable</code> interface.
 *
 * @author James Matthews
 *
 * @see org.jscience.computing.ai.ai.Navigable
 */
public class AStarPathfinder implements Pathfinder {
    /**
     * Returned by <code>getStatus</code> if a path <i>cannot</i> be
     * found.
     *
     * @see #getStatus
     */
    ...
    /**
     * Returned by <code>getStatus</code> if the pathfinder is still
     * running.
     *
     * @see #getStatus
     */
    ...
    /**
     * The current best node. The best node is taken from the open list
     * after every iteration of <code>doStep</code>.
     */
...
/**
    ...
    /**
     * Sets the navigable  to use in the pathfinder. The object must
     * implement the <code>Navigable</code> interface.
     *
    ...
    /**
     * Set the starting and goal points for the pathfinder. This method
     * uses <code>AStarNode</code>'s <i>x</i> and <i>y</i> variables, the
    ...
    /**
     * Link the children to the parent node. This method may also
     * update the parent path if a shorter path is found.
     *
...
/**
        ...
        /**
         * Resets the node. This involves all f, g and h-values to
         * 0 as well as removing all children.
         */
        public void reset() {
            f = g = h = 0.0;
            numChildren = 0;
