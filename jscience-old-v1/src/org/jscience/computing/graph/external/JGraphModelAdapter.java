 ...
 *
 * $Id: JGraphModelAdapter.java,v 1.2 2007-10-21 21:07:55 virtualcall Exp $
 *
 * Changes
 * -------
...
import org.jscience.computing.graph.events.GraphEdgeChangeEvent;
import org.jscience.computing.graph.events.GraphListener;
import org.jscience.computing.graph.events.GraphVertexChangeEvent;
 ...
 * org.jscience.computing.graph.ListenableGraph}. If the underlying JGraphT graph is
...
public class JGraphModelAdapter extends DefaultGraphModel {
    ...
    public JGraphModelAdapter(Graph jGraphTGraph,
        ...
        for (Iterator i = jGraphTGraph.edgeSet().iterator(); i.hasNext();) {
            handleJGraphTAddedEdge((org.jscience.computing.graph.Edge) i.next());
        }
     ...
     */
    public DefaultEdge getEdgeCell(org.jscience.computing.graph.Edge jGraphTEdge) {
    ...
    void handleJGraphChangedEdge(org.jgraph.graph.Edge jEdge) {
        if (isDangling(jEdge)) {
            ...
            if (m_cellToEdge.containsKey(jEdge)) {
                ...
                org.jscience.computing.graph.Edge jtEdge =
                        (org.jscience.computing.graph.Edge) m_cellToEdge.get(jEdge);
    ...
    void handleJGraphInsertedEdge(org.jgraph.graph.Edge jEdge) {
        if (isDangling(jEdge)) {
            ...
            if (added) {
                ...
                System.err.println("Warning: an edge was deleted because the underlying "
     ...
     */
    void handleJGraphTAddedEdge(org.jscience.computing.graph.Edge jtEdge) {
     ...
     *               graph model.
     */
    void handleJGraphTRemovedEdge(org.jscience.computing.graph.Edge jtEdge) {
    ...
    public static interface CellFactory {
         ...
         */
        public DefaultEdge createEdgeCell(org.jscience.computing.graph.Edge jGraphTEdge);
    ...
    public static class DefaultCellFactory implements CellFactory, Serializable {
        ...
        /**
         * @see org.jscience.computing.graph.external.JGraphModelAdapter.CellFactory#createEdgeCell(org.jscience.computing.graph.Edge)
         */
        public DefaultEdge createEdgeCell(org.jscience.computing.graph.Edge jGraphTEdge) {
        ...
        /**
         * @see org.jscience.computing.graph.external.JGraphModelAdapter.CellFactory#createVertexCell(Object)
         */
        public DefaultGraphCell createVertexCell(Object jGraphTVertex) {
    ...
    private class JGraphTListener implements GraphListener, Serializable {
        ...
        public void edgeAdded(GraphEdgeChangeEvent e) {
            org.jscience.computing.graph.Edge jtEdge = e.getEdge();
    ...
    private class ShieldedGraph {
        ...
        boolean addEdge(org.jscience.computing.graph.Edge jtEdge) {
        ...
        void removeEdge(org.jscience.computing.graph.Edge jtEdge) {
