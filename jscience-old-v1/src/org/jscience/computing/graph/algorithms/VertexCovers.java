 ...
 *
 * $Id: VertexCovers.java,v 1.2 2007-10-21 21:07:52 virtualcall Exp $
 *
 * Changes
 * -------
...
import org.jscience.computing.graph.algorithms.util.VertexDegreeComparator;
import org.jscience.computing.graph.graphs.Subgraph;
import org.jscience.computing.graph.graphs.UndirectedSubgraph;
...
public class VertexCovers {
     ...
     * org.jscience.computing.graph.GraphHelper#undirectedGraph(Graph)} or {@link
     * org.jscience.computing.graph.graph.AsUndirectedGraph}.
     * </p>
     *
     * @param g the graph for which vertex cover approximation is to be found.
     * @return a set of vertices which is a vertex cover for the specified
