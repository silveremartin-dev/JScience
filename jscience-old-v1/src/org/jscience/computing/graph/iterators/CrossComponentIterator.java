 ...
 *
 * $Id: CrossComponentIterator.java,v 1.3 2007-10-23 18:16:38 virtualcall Exp $
 *
 * Changes
 * -------
...
/**
 * Provides a cross-connected-component traversal functionality for
 * iterator subclasses.
 *
 * @author Barak Naveh
 *
...
public abstract class CrossComponentIterator extends AbstractGraphIterator {
    ...
    //
    /** DOCUMENT ME! */
    private final ConnectedComponentTraversalEvent m_ccFinishedEvent = new ConnectedComponentTraversalEvent(this,
            ConnectedComponentTraversalEvent.CONNECTED_COMPONENT_FINISHED);

    /** DOCUMENT ME! */
    private final ConnectedComponentTraversalEvent m_ccStartedEvent = new ConnectedComponentTraversalEvent(this,
...
/**
    ...
    /**
     * Returns <tt>true</tt> if there are no more uniterated vertices
     * in the currently iterated connected component; <tt>false</tt>
     * otherwise.
     *
    ...
    /**
     * Returns the vertex to be returned in the following call to the
     * iterator <code>next</code> method.
     *
...
/**
    ...
    /**
     * Provides unified interface for operations that are different in
     * directed graphs and in undirected graphs.
     */
    abstract static class Specifics {
        /**
         * Returns the edges outgoing from the specified vertex in
         * case of directed graph, and the edge touching the specified vertex
...
/**
    ...
    /**
     * An implementation of {@link TraverseUtils.Specifics} for a
     * directed graph.
     */
