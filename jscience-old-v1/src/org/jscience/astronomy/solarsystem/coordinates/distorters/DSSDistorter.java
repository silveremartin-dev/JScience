...
import org.jscience.astronomy.solarsystem.coordinates.TransformationException;
...
public class DSSDistorter extends Distorter
  implements Named
{
     ...
     */
    public class DSSInvDistorter extends Distorter {
