...
public class WCS extends Converter {
	...
	this.distort = new org.jscience.astronomy.solarsystem.coordinates.distorter.DSSDistorter(
	...
	double cv1 = toRadians(h.getDoubleValue("CRVAL1"));
	double cv2 = toRadians(h.getDoubleValue("CRVAL2"));
	...
	Scaler s1  = new Scaler(cp1, cp2, 1/cd1, 0, 0, 1/cd2);
	Scaler s2  = new Scaler(h.getDoubleValue("A0"),   h.getDoubleValue("B0"),
				h.getDoubleValue("A1")+1, h.getDoubleValue("A2"),
				h.getDoubleValue("B2"),   h.getDoubleValue("B1")+1);
	wcsKeys.put("A0", h.getDoubleValue("A0"));
	wcsKeys.put("A1", h.getDoubleValue("A1"));
	wcsKeys.put("A2", h.getDoubleValue("A2"));
	wcsKeys.put("B0", h.getDoubleValue("B0"));
	wcsKeys.put("B1", h.getDoubleValue("B1"));
	wcsKeys.put("B2", h.getDoubleValue("B2"));
	
	Distorter dis = new org.jscience.astronomy.solarsystem.coordinates.distorter.NeatDistorter(h.getDoubleValue("RADIAL"),
    ...
    public static void updateHeader(Header h, Scaler s, double[] crval, String projString, String coordString) 
      throws Exception {
