...
/**
 * SRF_LT_Params class declaration. This class holds the specific
 * parameters for SRF_LocalTangentSpaceAzimuthalSpherical
 *
 * @author David Shen
 */
public class SRF_LT_Params {
     ...
     * @return DOCUMENT ME!
     */
    public boolean isEqual(SRF_LT_Params params) {
        return ((this.geodetic_longitude == params.geodetic_longitude) &&
