 ...
 */
public class Coord2D_LocalSpacePolar extends Coord2D {
    /// Constructor with initial value defaulted to [ Double.NaN, Double.NaN ]
    public Coord2D_LocalSpacePolar(SRF_LocalSpacePolar srf) {
        super(srf, Coord_ClassType.POLAR);
        setValues(Double.NaN, Double.NaN);
    }

    /// Constructor with input values
    public Coord2D_LocalSpacePolar(SRF_LocalSpacePolar srf, double angle,
                                   double radius) {
        super(srf, Coord_ClassType.POLAR);
    ...
    public boolean isEqual(Coord coord) {
        ...
        return ((coord instanceof Coord2D_LocalSpacePolar) &&
