 ...
 */
public class Coord3D_HeliosphericEarthEquatorial extends Coord3D {
    /// Constructor with initial value defaulted to [ Double.NaN, Double.NaN, Double.NaN ]
    /**
     * Creates a new Coord3D_HeliosphericEarthEquatorial object.
     *
     * @param srf DOCUMENT ME!
     */
    public Coord3D_HeliosphericEarthEquatorial(
        SRF_HeliosphericEarthEquatorial srf) {
        super(srf, Coord_ClassType.HEEQ);
     ...
     */
    public Coord3D_HeliosphericEarthEquatorial(
        SRF_HeliosphericEarthEquatorial srf, double longitude, double latitude,
        double radius) {
        super(srf, Coord_ClassType.HEEQ);
    ...
    */
    public boolean isEqual(Coord coord) {
        ...
        return ((coord instanceof Coord3D_HeliosphericEarthEquatorial) &&
