 ...
 * @see SRF_Mercator
 */
public class CoordSurf_Mercator extends CoordSurf {
    /// Constructor with initial value defaulted to [ Double.NaN, Double.NaN ]
    /**
     * Creates a new CoordSurf_Mercator object.
     *
     * @param srf DOCUMENT ME!
     */
    public CoordSurf_Mercator(SRF_Mercator srf) {
     ...
     */
    public CoordSurf_Mercator(SRF_Mercator srf, double easting, double northing) {
        super(srf, Coord_ClassType.MERCATOR);
    ...
    */
    public boolean isEqual(Coord coord) {
        ...
        return ((coord instanceof CoordSurf_Mercator) &&
