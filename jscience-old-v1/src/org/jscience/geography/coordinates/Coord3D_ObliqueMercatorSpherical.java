 ...
 */
public class Coord3D_ObliqueMercatorSpherical extends Coord3D {
    /// Constructor with initial value defaulted to [ Double.NaN, Double.NaN, Double.NaN ]
    /**
     * Creates a new Coord3D_ObliqueMercatorSpherical object.
     *
     * @param srf DOCUMENT ME!
     */
    public Coord3D_ObliqueMercatorSpherical(SRF_ObliqueMercatorSpherical srf) {
        super(srf, Coord_ClassType.OMS);
     ...
     */
    public Coord3D_ObliqueMercatorSpherical(SRF_ObliqueMercatorSpherical srf,
        double easting, double northing, double ellipsoidal_height) {
        super(srf, Coord_ClassType.OMS);
    ...
    */
    public boolean isEqual(Coord coord) {
        ...
        return ((coord instanceof Coord3D_ObliqueMercatorSpherical) &&
