...
public class SRF_SolarMagneticEcliptic extends BaseSRF_3D {
    /// SRF_SolarMagneticEcliptic only constructor by ORM code and Hsr code
    /**
     * Creates a new SRF_SolarMagneticEcliptic object.
     *
     ...
     */
    public SRF_SolarMagneticEcliptic(SRM_ORM_Code orm, SRM_HSR_Code hsr)
        throws SrmException {
        _mySrftCode = SRM_SRFT_Code.SRFT_SOLAR_MAGNETIC_ECLIPTIC;
        _orm = orm;
        _hsr = hsr;

        SrfCheck.forSolarMagneticEcliptic(_orm, _hsr);
    }
    ...
    */
    public boolean isEqual(BaseSRF srf) {
        return ((srf != null) && (srf instanceof SRF_SolarMagneticEcliptic) &&
