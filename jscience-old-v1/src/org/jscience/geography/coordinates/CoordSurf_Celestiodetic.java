 ...
 */
public class CoordSurf_Celestiodetic extends CoordSurf {
    /// Constructor with initial value defaulted to [ Double.NaN, Double.NaN ]
    /**
     * Creates a new CoordSurf_Celestiodetic object.
     *
     * @param srf DOCUMENT ME!
     */
    public CoordSurf_Celestiodetic(SRF_Celestiodetic srf) {
     ...
     */
    public CoordSurf_Celestiodetic(SRF_Celestiodetic srf, double longitude,
        double latitude) {
        super(srf, Coord_ClassType.CD);
    ...
    */
    public boolean isEqual(Coord coord) {
        ...
        return ((coord instanceof CoordSurf_Celestiodetic) &&
