...
public class SRF_HeliosphericEarthEcliptic extends BaseSRF_3D {
    /// SRF_HeliosphericEarthEcliptic only constructor by ORM code and Hsr code
    /**
     * Creates a new SRF_HeliosphericEarthEcliptic object.
     *
     ...
     */
    public SRF_HeliosphericEarthEcliptic(SRM_ORM_Code orm, SRM_HSR_Code hsr)
        throws SrmException {
        _mySrftCode = SRM_SRFT_Code.SRFT_HELIOSPHERIC_EARTH_ECLIPTIC;
        _orm = orm;
        _hsr = hsr;

        SrfCheck.forHeliosphericEarthEcliptic(_orm, _hsr);
    }
    ...
    public Coord3D createCoordinate3D() {
        return new Coord3D_HeliosphericEarthEcliptic((SRF_HeliosphericEarthEcliptic) this,
    ...
    */
    public boolean isEqual(BaseSRF srf) {
        return ((srf != null) &&
        (srf instanceof SRF_HeliosphericEarthEcliptic) &&
