...
public class SRF_Mercator extends BaseSRF_MapProjection {
    /// SRF Parameter data using SRF_Mercator_Params
    /** DOCUMENT ME! */
    private SRF_Mercator_Params _params = new SRF_Mercator_Params();

    /// Constructor by SRF parameter object
    /**
     * Creates a new SRF_Mercator object.
     *
     ...
     */
    public SRF_Mercator(SRM_ORM_Code orm, SRM_HSR_Code hsr,
        SRF_Mercator_Params params) throws SrmException {
        _mySrftCode = SRM_SRFT_Code.SRFT_MERCATOR;
        _orm = orm;
        _hsr = hsr;
        ...
        SrfCheck.forMercator(_orm, _hsr, _params);
    }
     ...
     * @param origin_latitude DOCUMENT ME!
     ...
     */
    public SRF_Mercator(SRM_ORM_Code orm, SRM_HSR_Code hsr,
        double origin_longitude, double origin_latitude, double central_scale,
        double false_easting, double false_northing) throws SrmException {
        _mySrftCode = SRM_SRFT_Code.SRFT_MERCATOR;
        _orm = orm;
        _hsr = hsr;
    ...
    public Coord3D createCoordinate3D() {
        return new Coord3D_Mercator((SRF_Mercator) this, Double.NaN,
    ...
    public Coord3D createCoordinate3D(double coord_comp1, double coord_comp2,
        double coord_comp3) {
        return new Coord3D_Mercator((SRF_Mercator) this, coord_comp1,
    ...
    public CoordSurf createSurfaceCoordinate() {
        return new CoordSurf_Mercator((SRF_Mercator) this, Double.NaN,
            Double.NaN);
    }
    ...
    public CoordSurf createSurfaceCoordinate(double coord_comp1,
        double coord_comp2) {
        return new CoordSurf_Mercator((SRF_Mercator) this, coord_comp1,
            coord_comp2);
    }
     ...
     * @return DOCUMENT ME!
     */
    public SRF_Mercator_Params getSRFParameters() {
        SRF_Mercator_Params retParams = new SRF_Mercator_Params();
    ...
    */
    public boolean isEqual(BaseSRF srf) {
        return ((srf != null) && (srf instanceof SRF_Mercator) &&
    ...
    public String toString() {
        ...
        retString = retString + "origin_latitude: " + _params.origin_latitude +
            "\n";
