 ...
 * @see SRF_Mercator
 */
public class Coord3D_Mercator extends Coord3D {
    /// Constructor with initial value defaulted to [ Double.NaN, Double.NaN, Double.NaN ]
    /**
     * Creates a new Coord3D_Mercator object.
     *
     * @param srf DOCUMENT ME!
     */
    public Coord3D_Mercator(SRF_Mercator srf) {
        super(srf, Coord_ClassType.MERCATOR);
     ...
     */
    public Coord3D_Mercator(SRF_Mercator srf, double easting, double northing,
    ...
    */
    public boolean isEqual(Coord coord) {
        ...
        return ((coord instanceof Coord3D_Mercator) &&
