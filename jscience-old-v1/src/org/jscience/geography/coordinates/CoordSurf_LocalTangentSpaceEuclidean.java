 ...
 */
public class CoordSurf_LocalTangentSpaceEuclidean extends CoordSurf {
    /// Constructor with initial value defaulted to [ Double.NaN, Double.NaN ]
    /**
     * Creates a new CoordSurf_LocalTangentSpaceEuclidean object.
     *
     * @param srf DOCUMENT ME!
     */
    public CoordSurf_LocalTangentSpaceEuclidean(
        SRF_LocalTangentSpaceEuclidean srf) {
        super(srf, Coord_ClassType.LTSE);
     ...
     */
    public CoordSurf_LocalTangentSpaceEuclidean(
        SRF_LocalTangentSpaceEuclidean srf, double x, double y) {
        super(srf, Coord_ClassType.LTSE);
        setValues(x, y);
    }
    ...
    */
    public boolean isEqual(Coord coord) {
        ...
        return ((coord instanceof CoordSurf_LocalTangentSpaceEuclidean) &&
