...
public class SRF_PolarStereographic extends BaseSRF_MapProjection {
    ...
    /**
     * Creates a new SRF_PolarStereographic object.
     *
     ...
     */
    public SRF_PolarStereographic(SRM_ORM_Code orm, SRM_HSR_Code hsr,
        SRF_PS_Params params) throws SrmException {
        _mySrftCode = SRM_SRFT_Code.SRFT_POLAR_STEREOGRAPHIC;
        _orm = orm;
        _hsr = hsr;
        _params.polar_aspect = params.polar_aspect;
        _params.origin_longitude = params.origin_longitude;
        _params.true_scale_latitude = params.true_scale_latitude;
        _params.true_scale = params.true_scale;
        _params.false_easting = params.false_easting;
        _params.false_northing = params.false_northing;

        SrfCheck.forPolarStereographic(_orm, _hsr, _params);
    }
     ...
     * @param orm DOCUMENT ME!
     * @param hsr DOCUMENT ME!
     * @param polar_aspect DOCUMENT ME!
     * @param origin_longitude DOCUMENT ME!
     * @param true_scale_latitude DOCUMENT ME!
     * @param true_scale DOCUMENT ME!
     ...
     */
    public SRF_PolarStereographic(SRM_ORM_Code orm, SRM_HSR_Code hsr,
        SRM_Polar_Aspect polar_aspect, double origin_longitude,
        double true_scale_latitude, double true_scale, double false_easting,
        ...
        _params.true_scale_latitude = true_scale_latitude;
        _params.true_scale = true_scale;
    ...
    public SRF_PS_Params getSRFParameters() {
        ...
        retParams.true_scale_latitude = _params.true_scale_latitude;
        retParams.true_scale = _params.true_scale;
    ...
    /// Returns the true_scale_latitude SRF parameter value
    /**
     * DOCUMENT ME!
     *
     * @return DOCUMENT ME!
     */
    public double get_true_scale_latitude() {
        return _params.true_scale_latitude;
    }

    /// Returns the true_scale SRF parameter value
    /**
     * DOCUMENT ME!
     *
     * @return DOCUMENT ME!
     */
    public double get_true_scale() {
        return _params.true_scale;
    }
    ...
    */
    public boolean isEqual(BaseSRF srf) {
        return ((srf != null) && (srf instanceof SRF_PolarStereographic) &&
    ...
    public String toString() {
        ...
        retString = retString + "polar_aspect: " + _params.polar_aspect + "\n";
        retString = retString + "origin_longitude: " +
            _params.origin_longitude + "\n";
        retString = retString + "true_scale_latitude: " +
            _params.true_scale_latitude + "\n";
        retString = retString + "true_scale: " + _params.true_scale + "\n";
