 ...
 * @see BaseSRF_2D
 */
public class SRF_LocalSpaceAzimuthal extends BaseSRF_2D {
    /// SRF_LocalSpaceAzimuthal only constructor by ORM code and Hsr code
    /**
     * Creates a new SRF_LocalSpaceAzimuthal object.
     *
     ...
     */
    public SRF_LocalSpaceAzimuthal(SRM_ORM_Code orm, SRM_HSR_Code hsr)
        throws SrmException {
        _mySrftCode = SRM_SRFT_Code.SRFT_LOCAL_SPACE_AZIMUTHAL;
        _orm = orm;
        _hsr = hsr;

        SrfCheck.forLocalSpaceAzimuthal(_orm, _hsr);
    }
    ...
    public Coord2D createCoordinate2D() {
        return new Coord2D_LocalSpaceAzimuthal((SRF_LocalSpaceAzimuthal) this,
    ...
    */
    public boolean isEqual(BaseSRF srf) {
        return ((srf != null) && (srf instanceof SRF_LocalSpaceAzimuthal) &&
