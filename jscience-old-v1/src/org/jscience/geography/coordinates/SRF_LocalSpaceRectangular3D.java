...
public class SRF_LocalSpaceRectangular3D extends BaseSRF_3D {
    ...
    /**
     * Creates a new SRF_LocalSpaceRectangular3D object.
     *
     ...
     */
    public SRF_LocalSpaceRectangular3D(SRM_ORM_Code orm, SRM_HSR_Code hsr,
        SRF_LSR_3D_Params params) throws SrmException {
        _mySrftCode = SRM_SRFT_Code.SRFT_LOCAL_SPACE_RECT_3D;
        _orm = orm;
        _hsr = hsr;
        _params.up_direction = params.up_direction;
        _params.forward_direction = params.forward_direction;

        SrfCheck.forLocalSpaceRectangular3D(_orm, _hsr, _params);
    }
     ...
     * @param orm DOCUMENT ME!
     * @param hsr DOCUMENT ME!
     * @param up_direction DOCUMENT ME!
     * @param forward_direction DOCUMENT ME!
     *
     * @throws SrmException DOCUMENT ME!
     */
    public SRF_LocalSpaceRectangular3D(SRM_ORM_Code orm, SRM_HSR_Code hsr,
        SRM_Axis_Direction up_direction, SRM_Axis_Direction forward_direction)
        throws SrmException {
        _mySrftCode = SRM_SRFT_Code.SRFT_LOCAL_SPACE_RECT_3D;
        _orm = orm;
        _hsr = hsr;
    ...
    */
    public boolean isEqual(BaseSRF srf) {
        return ((srf != null) && (srf instanceof SRF_LocalSpaceRectangular3D) &&
