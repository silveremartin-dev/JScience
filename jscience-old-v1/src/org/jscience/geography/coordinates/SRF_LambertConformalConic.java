...
public class SRF_LambertConformalConic extends BaseSRF_MapProjection {
    ...
    /**
     * Creates a new SRF_LambertConformalConic object.
     *
     ...
     */
    public SRF_LambertConformalConic(SRM_ORM_Code orm, SRM_HSR_Code hsr,
        SRF_LCC_Params params) throws SrmException {
        _mySrftCode = SRM_SRFT_Code.SRFT_LAMBERT_CONFORMAL_CONIC;
        _orm = orm;
        _hsr = hsr;
        ...
        SrfCheck.forLambertConformalConic(_orm, _hsr, _params);
    }
     ...
     */
    public SRF_LambertConformalConic(SRM_ORM_Code orm, SRM_HSR_Code hsr,
        double origin_longitude, double origin_latitude, double latitude1,
        double latitude2, double false_easting, double false_northing)
        throws SrmException {
        _mySrftCode = SRM_SRFT_Code.SRFT_LAMBERT_CONFORMAL_CONIC;
        _orm = orm;
        _hsr = hsr;
    ...
    public Coord3D createCoordinate3D() {
        return new Coord3D_LambertConformalConic((SRF_LambertConformalConic) this,
    ...
    public CoordSurf createSurfaceCoordinate() {
        return new CoordSurf_LambertConformalConic((SRF_LambertConformalConic) this,
    ...
    */
    public boolean isEqual(BaseSRF srf) {
        return ((srf != null) && (srf instanceof SRF_LambertConformalConic) &&
        (this._orm == srf.get_orm()) && (this._hsr == srf.get_hsr()) &&
        this._params.isEqual(((SRF_LambertConformalConic) srf).getSRFParameters()));
    }
