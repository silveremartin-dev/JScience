...
public class Coord3D_LocalTangentSpaceEuclidean extends Coord3D {
    ...
    /**
     * Creates a new Coord3D_LocalTangentSpaceEuclidean object.
     *
     * @param srf DOCUMENT ME!
     */
    public Coord3D_LocalTangentSpaceEuclidean(
     ...
     */
    public Coord3D_LocalTangentSpaceEuclidean(
        SRF_LocalTangentSpaceEuclidean srf, double x, double y, double height) {
        super(srf, Coord_ClassType.LTSE);
