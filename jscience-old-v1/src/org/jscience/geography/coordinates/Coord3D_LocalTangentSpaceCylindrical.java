 ...
 */
public class Coord3D_LocalTangentSpaceCylindrical extends Coord3D {
    /// Constructor with initial value defaulted to [ Double.NaN, Double.NaN, Double.NaN ]
    /**
     * Creates a new Coord3D_LocalTangentSpaceCylindrical object.
     *
     * @param srf DOCUMENT ME!
     */
    public Coord3D_LocalTangentSpaceCylindrical(
        SRF_LocalTangentSpaceCylindrical srf) {
        super(srf, Coord_ClassType.LTSC);
     ...
     */
    public Coord3D_LocalTangentSpaceCylindrical(
        SRF_LocalTangentSpaceCylindrical srf, double angle, double radius,
        double height) {
        super(srf, Coord_ClassType.LTSC);
        setValues(angle, radius, height);
    }
     ...
     * @param height DOCUMENT ME!
     */
    public void setValues(double angle, double radius, double height) {
        _values[0] = angle;
        _values[1] = radius;
        _values[2] = height;
    }
    ...
    */
    public boolean isEqual(Coord coord) {
        ...
        return ((coord instanceof Coord3D_LocalTangentSpaceCylindrical) &&
