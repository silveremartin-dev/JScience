...
public class CoordSurf_PolarStereographic extends CoordSurf {
    ...
    */
    public boolean isEqual(Coord coord) {
        ...
        return ((coord instanceof CoordSurf_PolarStereographic) &&
