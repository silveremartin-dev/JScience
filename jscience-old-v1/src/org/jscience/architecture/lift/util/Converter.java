 ...
 * Changelog:<br>
 * 2005 March 13 - Working, tested, a bit obsoleted, still in use in at least 4 projects.<br>
 * This file is a half-ready (hald-done) converter utility used to convert CSV files to many other formats.
 */
