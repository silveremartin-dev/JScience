...
/**
 * This class contains a few static utility methods that are used by the
 * various parts of the XML parser
 */
public class XMLUtils {
     ...
     * non-alphanumeric string should be processed by this method before
     * saving!
     *
    ...
    /**
     * Convert a full XML name to its generic name. This is done by
     * checking if each part of the name is complex (if it consists of a
     * generic name plus a specific name). If so, then the specific part is
     * removed. Array elements are also removed from the name. Example of a
     * complex name : model.infrastructure.node-edge.spdata Result of
     * getGenericName  : model.infrastructure.node.spdata
     *
     * @param fullName The XML name
     *
     * @return The result
     */
     ...
     * checking if each part of the name is complex (if it consists of a
     * generic name plus a specific name). If so, then the specific part is
     * removed.  Example of a complex name :
    ...
    public static String getGenericName(String fullName, boolean removeArrays) {
        ...
        while (s.hasMoreTokens()) {
            ...
            if (removeArrays &&
                    (("array").equals(tmp) || ("element").equals(tmp))) {
                continue;
            }
    ...
    /**
     * Takes the last name of a full XML tag name. If it consists of a
     * generic part and a specific part, then the generic part is removed.
    ...
    /**
     * Load the second stage of an enumeration of objects that
     * implement TwoStageLoader
     *
     * @param e The enumeration of TwoStageLoaders
     * @param dictionaries The main dictionary to load them with
     *
     * @throws XMLInvalidInputException If one of the elements in the
     *         enumeration is not a TwoStageLoader
     * @throws XMLTreeException DOCUMENT ME!
     */
    public static void loadSecondStage(Enumeration e, Dictionary dictionaries)
     ...
     *
     * @throws XMLTreeException If one of the elements in the enumeration is
     *         not XMLSerializable
     */
    public static void setParentName(Enumeration e, String newParentName)
