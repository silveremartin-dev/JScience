 ...
 * @version 1.0 An extension of QuadCurve to draw roads, and calculate roaduser positions
 */
...
/**
    ...
    public TurnCurve(Point p1, Point cp, Point p2) {
        super((double) p1.x, (double) p1.y, (double) cp.x, (double) cp.y,
...
/**
    ...
    /**
     * Returns true if this TurnCurve is actually a straight line,
     * false otherwise
     *
     * @return DOCUMENT ME!
     */
    ...
    /**
     * Let the PathIterator do a step and if successfull return the
     * coordinates of it's current position
     *
     * @return The coordinats of the PathIterator's position, or null if no
     *         step was possible
     */
    public Point next() {
    ...
    /**
     * Return the coordinates of the point with a given index on this
     * TurnCurve
     *
