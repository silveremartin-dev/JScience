...
public class Selection extends Observable implements Overlay {
    ...
    public void paint(Graphics gr) throws TrafficException {
    ...
    public void setSelection(Selection s) {
        selectedObjects = (LinkedList) s.getSelectedObjects().clone();
    }
     ...
     * @see Selection#selects(Pointp,Selectableo)
     */
     ...
     * @return a list of all Selectables that are selected by given point
     * @see Selectable#getChildren()
     * @see Selection#selects(Rectangler,Selectableo)
     */
