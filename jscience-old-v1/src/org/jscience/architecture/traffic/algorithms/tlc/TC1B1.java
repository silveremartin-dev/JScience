 ...
 * learning. Now Bucketed Now Optimized 2.0
 *
 * @author Arne K, Jilles V
 * @version 0.915
 */
public class TC1B1 extends TLController implements Colearning,
    InstantiationAssistant {
    /** DOCUMENT ME! */
    protected static int BUCK = 0;

    /** DOCUMENT ME! */
    protected static int WAIT = 1;
...
/**
        ...
        for (int i = 0; i < num_nodes; i++) {
            ...
            for (int j = 0; j < num_dec; j++) {
                ...
                for (int k = 0; k < waitingsize; k++) {
                    ...
                    gain += (passenger_factor * (q_table[tlId][pos][desId][red_index] -
                    q_table[tlId][pos][desId][green_index])); //red - green
                }
     ...
     * green.
     *
     * @param laneId The Drivelane the Roaduser was on just before.
     * @param prevpos DOCUMENT ME!
     */
    ...
    */
    protected void recalcP(int tlId, int pos, int desId, boolean light,
        ...
        CountEntry currentsituation = new CountEntry(tlId, pos, desId, light,
                tlNewId, posNew);
