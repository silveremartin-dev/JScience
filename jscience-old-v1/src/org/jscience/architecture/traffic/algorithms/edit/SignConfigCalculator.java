 ...
 *------------------------------------------------------------------------*/
package org.jscience.architecture.traffic.algorithms.edit;
...
public class SignConfigCalculator {
    ...
    public Sign[][] calcSC(Node nd) throws InfraException {
        ...
        for (Iterator it1 = possibleConfigs.iterator(); it1.hasNext();) {
            ...
            for (Enumeration e = possibleConfigs.elements();
                    e.hasMoreElements();) {
    ...
    private class Config {
        /** DOCUMENT ME! */
        Vector green; //Indicates which inbound-lanes are green in this configuration
...
/**
         ...
         *
         * @param nd DOCUMENT ME!
         * @param cfg1 DOCUMENT ME!
         * @param cfg2 DOCUMENT ME!
         */
        public Config(Node nd, Config cfg1, Config cfg2) {
            ...
            if (cfg2 != null) {
                for (Enumeration e = cfg2.green.elements();
                        e.hasMoreElements();) {
                    gr = (Green) e.nextElement();
         ...
         * DOCUMENT ME!
         *
         * @param gr1 DOCUMENT ME!
         * @param gr2 DOCUMENT ME!
         *
         * @return DOCUMENT ME!
         *
         * @throws InfraException DOCUMENT ME!
         */
        private boolean collisionDetect(Green gr1, Green gr2)
            throws InfraException {
            for (int i = 0; i < gr1.outlanes.length; i++) {
                for (int j = 0; j < gr2.outlanes.length; j++) {
                    boolean collision = false;
                    Drivelane il1 = gr1.inlane;
                    Drivelane il2 = gr2.inlane;
                    Drivelane ol1 = gr1.outlanes[i];
                    Drivelane ol2 = gr2.outlanes[j];

                    if ((il1 == null) || (il2 == null) || (ol1 == null) ||
                            (ol2 == null)) {
                    ...
                    if (k >= cw.length) {
                        System.out.println(
                            "ERROR IN getAllLanesCW in Class Junction/Node, reported by SignConfigCalculator.Config.CollisionDetect");
...
/**
             ...
             *
             * @param inl  DOCUMENT ME!
             * @param outl DOCUMENT ME!
             */
