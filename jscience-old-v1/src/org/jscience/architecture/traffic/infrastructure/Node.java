...
public abstract class Node implements Selectable, XMLSerializable,
    ...
    /** DOCUMENT ME! */
    /** DOCUMENT ME! */
    public static final int C_LEFT = 3;
    ...
    /** DOCUMENT ME! */
    /** DOCUMENT ME! */
    public static final int D_BACK = 0;
    ...
    /** DOCUMENT ME! */
    /** DOCUMENT ME! */
    public static final int D_AHEAD = 2;
...
/**
     ...
     *        constant, see above)
     *
     * @return The Direction from src to dest (expressed in D_ constants, see
    ...
    /**
     * Calculates the number of positions a roaduser can skip in the
     * tail of its destination lane
     *
     ...
     */
    public int getNumSkip(int direction, int laneNumber)
    ...
    /**
     * Processes the statistics of a Roaduser crossing/arriving at this
     * node.
     *
    ...
    public void load(XMLElement myElement, XMLLoader loader)
        ...
        if (Model.SAVE_STATS) {
            statistics = (NodeStatistics[]) XMLArray.loadArray(this, loader,
                    this);
        } else {
            initStats();
        }
    ...
    public Rectangle getBounds() {
        ...
        return new Rectangle((int) (coord.x - (w * 5)),
            (int) (coord.y - (w * 5)), w * 10, w * 10);
    }
     ...
     */
    public abstract void paint(Graphics g) throws TrafficException;
     ...
     * @throws TrafficException DOCUMENT ME!
     */
    public abstract void paint(Graphics g, int offx, int offy, float zf)
    ...
    /**
     * Returns the name of this node. The name of a node is unique in
     * an infrastructure.
     *
     * @return DOCUMENT ME!
     */
    ...
    /**
     * Returns all roads connected to this node. This may contain null
     * pointers
     *
     * @return DOCUMENT ME!
     */
     ...
     *
     * @throws InfraException if a road is already connected at the given
     *         position
     */
     ...
     *
     * @throws InfraException if no road is connected at the given position
     */
     ...
     *
     * @throws InfraException if r is null
     */
    ...
    /**
     * Returns the desired type of signs to add to inbound lanes on
     * this node.
     *
     * @return DOCUMENT ME!
     *
     ...
     *
     * @throws InfraException if the given position is not a valid
     *         connection-position
     */
    ...
    /**
     * Returns an array of all inbound lanes supporting roadusers of
     * given type that lead to the given outbound lane.
     *
     ...
     *
     * @throws InfraException if the given lane is not an outbound lane on this
     *         node
     */
    public abstract Drivelane[] getLanesLeadingTo(Drivelane lane, int ruType)
        throws InfraException;

    /**
     * Returns an array of all outbound lanes supporting roadusers of
     * given type that can be reached from the given inbound lane.
     *
     ...
     *
     * @throws InfraException if the given lane is not an inbound lane on this
     *         node
     */
    public abstract Drivelane[] getLanesLeadingFrom(Drivelane lane, int ruType)
        throws InfraException;
    ...
    /**
     * Returns whether or not all the Tails of all the outbound lanes
     * of this Node are free or not
     *
     * @return DOCUMENT ME!
     */
    ...
    /**
     * Removes all lanes on the path towards nodeId with length larger
     * than length
     *
     * @param nodeId DOCUMENT ME!
     * @param ruType DOCUMENT ME!
    ...
    /**
     * Basic node statistics. Class to maintain statistics for one
     * roaduser type.
     *
...
/**
        ...
        /**
         * Returns the total number of roadusers that
         * crossed/arrived at this node.
         *
         * @return DOCUMENT ME!
         */
        ...
        /**
         * Returns the average waiting time the roadusers
         * experienced.
         *
