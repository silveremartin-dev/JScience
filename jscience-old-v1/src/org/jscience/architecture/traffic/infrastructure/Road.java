...
import org.jscience.architecture.traffic.util.*;
...
/**
    ...
    public void loadSecondStage(Dictionary dictionaries)
        throws XMLInvalidInputException, XMLTreeException { // Load nodes
        ...
        */
        ...
        for (int t = 0; t < alphaLanes.length; t++)
            alphaLanes[t] = (Drivelane) (laneDictionary.get(new Integer(
                        loadData.alphaLaneIds[t])));

        for (int t = 0; t < betaLanes.length; t++)
            betaLanes[t] = (Drivelane) (laneDictionary.get(new Integer(
                        loadData.betaLaneIds[t])));
    }
    ...
    /**
     * Returns the Drivelanes where Roadusers move towards the
     * alphaNode
     *
     * @return DOCUMENT ME!
     */
    ...
    /**
     * Returns the name of this road. The name of a road is unique in
     * an infrastructure.
     *
     * @return DOCUMENT ME!
     */
    ...
    public Enumeration getChildren() {
        return new ArrayEnumeration(alphaLanes, betaLanes);
    }
     ...
     *
     * @throws InfraException if l is null
     */
     ...
     *
     * @throws InfraException if t is null
     */
     ...
     *
     * @throws InfraException if lane or to is null
     */
     ...
     *
     * @throws InfraException if lane is null
     */
    public void remLane(Drivelane lane) throws InfraException {
        ...
        throw new InfraException(
            "Lane is neither an alpha, nor a beta lane on this road");
    }
    ...
    /*============================================*/
    /**
     * Returns the other node this road is connected to, seen from the
     * given node
     *
     * @param seenfrom DOCUMENT ME!
     *
     * @return DOCUMENT ME!
     */
    ...
    /**
     * Returns the number of Drivelanes that are outbound from the
     * given node
     *
     * @param n DOCUMENT ME!
     *
     * @return DOCUMENT ME!
     *
     * @throws InfraException if n is null
     */
    ...
    /**
     * Returns the number of Drivelanes that are inbound on the given
     * node
     *
     * @param n DOCUMENT ME!
     *
    ...
    /**
     * Returns an array of Drivelanes which are outbound from the given
     * node.
     *
     * @param n DOCUMENT ME!
     *
    ...
    /**
     * Returns an array of Drivelanes which are inbound on the node
     * given.
     *
     * @param n DOCUMENT ME!
     *
    ...
    /**
     * Draws this Road, with all it's DriveLanes and Roadusers onto a
     * Graphics object, mostly a View
     *
    ...
    /**
     * Paints an arbitrary segment of a drivelane and returns the
     * outlines of this segment as a Shape
     *
     * @param g DOCUMENT ME!
     * @param p1_1 DOCUMENT ME!
     * @param p1_2 DOCUMENT ME!
     * @param p2_1 DOCUMENT ME!
     * @param p2_2 DOCUMENT ME!
     ...
     * @return DOCUMENT ME!
     */
    public Shape paintDrivelaneSegment(Graphics g, Point p1_1, Point p1_2,
        Point p2_1, Point p2_2, double a1, double a2, Drivelane dl) {
        switch (dl.getType()) {
        case 1:
     ...
     *        segment
     */
    public void paintRoaduser(Graphics g, Roaduser r, Point p1, Point p2,
        double a1, double a2, int pos) {
        try {
     ...
     */
    public void paintRoaduserOnNode(Graphics g, Roaduser ru, Node node,
        Point p, int pos, Drivelane d) {
        double na = 0.0;
            ...
            for (int i = 0; i < dls.length; i++)
                if (dls[i].getId() == id) {
                    ...
                    for (int j = 0; j < dls.length; j++)
                        if (dls[j].getId() == id) {
                            Point q = new Point((int) (((double) node.getCoord().x +
                                    (Math.cos(na) * 5.0 * node.getWidth())) -
                                    (Math.sin(na) * 10.0 * (double) j) -
                                    (Math.sin(na) * 5.0)),
                                    (int) ((double) node.getCoord().y -
                                    (Math.sin(na) * 5.0 * node.getWidth()) -
                                    (Math.cos(na) * 10.0 * (double) j) -
                                    (Math.cos(na) * 5.0)));
                            ...
                            if (q.x == p.x) {
                                ...
                                ra = Math.atan((double) (q.x - p.x) / (double) (q.y -
                                        p.y));
                            }
     ...
     * @param d DOCUMENT ME!
     */
    public void paintDrivelaneAttributes(Graphics g, Point p, double a,
        Drivelane d) {
        // draw sign
        Point q = new Point((int) (p.x - (7 * Math.cos(a))),
                (int) (p.y + (7 * Math.sin(a))));
        Sign s = d.getSign();
        ...
        // draw directions
        Point q1 = new Point((int) (p.x + (5 * Math.cos(a))),
                (int) (p.y - (5 * Math.sin(a))));
        Point q2 = new Point((int) (p.x + (8 * Math.cos(a))),
                (int) (p.y - (8 * Math.sin(a))));
        Point q3 = new Point((int) (p.x + (3 * Math.cos(a))),
                (int) (p.y - (3 * Math.sin(a))));
        Point q4 = new Point((int) (p.x + Math.cos(a)),
                (int) (p.y - Math.sin(a)));
        g.setColor(Color.black);
    ...
    public void paint(Graphics g, int x, int y, float zf, double bogus)
        ...
        if ((turns.length > 0) && !vertical) {
            ...
            for (int n = 0; n < alphaLanes.length; n++) {
                ...
                Point p2_1 = getCurvePoint(alphaCoord, alphaAngle, -1, n + 1,
                        x, y);
                Point p2_2 = getCurvePoint(turns[0].getCoord(), ta, 1, n + 1,
                        x, y);
                Shape bounds = paintDrivelaneSegment(g, p1_1, p1_2, p2_1, p2_2,
                        alphaAngle, ta, alphaLanes[n]);
                alphaLanes[n].clearCurveBounds();
                alphaLanes[n].addCurveBounds(bounds);
                paintDrivelaneAttributes(g, avg(p1_1, p2_1), alphaAngle,
                    alphaLanes[n]);
            }
            ...
            for (int n = 0; n < betaLanes.length; n++) {
                Point p1_1 = getCurvePoint(alphaCoord, alphaAngle, 1, n, x, y);
                Point p1_2 = getCurvePoint(turns[0].getCoord(), ta, -1, n, x, y);
                Point p2_1 = getCurvePoint(alphaCoord, alphaAngle, 1, n + 1, x,
                        y);
                Point p2_2 = getCurvePoint(turns[0].getCoord(), ta, -1, n + 1,
                        x, y);
                Shape bounds = paintDrivelaneSegment(g, p1_1, p1_2, p2_1, p2_2,
                        alphaAngle, ta, betaLanes[n]);
        ...
        for (int t = 0; t < (turns.length - 1); t++) {
            ...
            double ta2 = CurveUtils.normalize(turns[t + 1].getAngle() +
                    Math.PI);
        ...
        if ((turns.length > 0) && !vertical) {
            ...
            for (int n = 0; n < betaLanes.length; n++) {
                ...
                Shape bounds = paintDrivelaneSegment(g, p1_1, p1_2, p2_1, p2_2,
                        ta, betaAngle, betaLanes[n]);
                paintDrivelaneAttributes(g, avg(p1_2, p2_2),
                    betaAngle + Math.PI, betaLanes[n]);
                betaLanes[n].addCurveBounds(bounds);
            }
                                ...
                                if ((t < turns.length) && (pos < length)) {
                                    if (turns[t].getPosition() >= pos) {
                                        ...
                                        if (t == 0) // alpha->turns[0]
                                         {
                                            tp1 = new Point((int) (alphaCoord.x +
                                                    (5 * Math.cos(alphaAngle))),
                                                    (int) (alphaCoord.y -
                                                    (5 * Math.sin(alphaAngle))));
                                            tp2 = turns[t].getCoord();
                                            ta1 = alphaAngle;
                                            ta2 = turns[t].getAngle() +
                                                Math.PI;
                                        } else {
                                            ...
                                            ta2 = turns[t].getAngle() +
                                                Math.PI;
                                            cpos = pos -
                                                (int) (turns[t - 1].getPosition());
                                        }

                                        Point p1 = avg(getCurvePoint(tp1, ta1,
                                                    -1, n, x, y),
                                                getCurvePoint(tp1, ta1, -1,
                                                    (n + 1), x, y));
                                        Point p2 = avg(getCurvePoint(tp2, ta2,
                                                    1, n, x, y),
                                                getCurvePoint(tp2, ta2, 1,
                                                    (n + 1), x, y));
                                        paintRoaduser(g, r, p1, p2, ta1, ta2,
                                            cpos);
                                    ...
                                    Point tp2 = new Point((int) (betaCoord.x -
                                            (5 * Math.cos(betaAngle))),
                                            (int) (betaCoord.y +
                                            (5 * Math.sin(betaAngle))));
                                    double ta1 = turns[t - 1].getAngle();
                                    double ta2 = betaAngle;
                                    int cpos = pos -
                                        (int) (turns[t - 1].getPosition()) + 1;
                                    Point p1 = avg(getCurvePoint(tp1, ta1, -1,
                                                n, x, y),
                                            getCurvePoint(tp1, ta1, -1, n + 1,
                                                x, y));
                                    Point p2 = avg(getCurvePoint(tp2, ta2, -1,
                                                n, x, y),
                                            getCurvePoint(tp2, ta2, -1, n + 1,
                                                x, y));
                                    paintRoaduser(g, r, p1, p2, ta1, ta2, cpos);
                                } else {
                                    Point tp1 = new Point((int) (betaCoord.x -
                                            (5 * Math.cos(betaAngle))),
                                            (int) (betaCoord.y +
                                            (5 * Math.sin(betaAngle))));
                                    Point p = avg(getCurvePoint(tp1, betaAngle,
                                                -1, n, x, y),
                                            getCurvePoint(tp1, betaAngle, -1,
                                                n + 1, x, y));
                                    paintRoaduserOnNode(g, r, betaNode, p,
                                        pos - length, dl);
                                }
                            }
                        } // alphaturnloop
...
betaturnloop:  {
                            for (int t = 0; t <= turns.length; t++) {
                                if ((t < turns.length) && (pos >= 0)) {
                                    ...
                                    Point tp1 = new Point((int) (alphaCoord.x -
                                            (5 * Math.cos(alphaAngle))),
                                            (int) (alphaCoord.y +
                                            (5 * Math.sin(alphaAngle))));
                                    Point p = avg(getCurvePoint(tp1,
                                                alphaAngle, 1, n, x, y),
                                            getCurvePoint(tp1, alphaAngle, 1,
                                                n + 1, x, y));
                                    paintRoaduserOnNode(g, r, alphaNode, p,
                                        pos, dl);
                                }
                            }
                        } // betaturnloop
        ...
        } else // straight road
         {
            ...
            } else if ((betaNode.coord.y < alphaNode.coord.y) &&
                    (betaNode.coord.x > alphaNode.coord.x)) {
                dlangle = Math.toRadians(180) +
                    Math.atan((double) (betaNode.coord.x - alphaNode.coord.x) / (double) (betaNode.coord.y -
                        alphaNode.coord.y));
            } else {
                dlangle = Math.atan((double) (betaNode.coord.x -
                        alphaNode.coord.x) / (double) (betaNode.coord.y -
                        alphaNode.coord.y));
            }
            ...
            g.setColor(Color.black);
            g.drawLine((int) ((sx1 + x) * zf), (int) ((sy1 + y) * zf),
                (int) ((ex1 + x) * zf), (int) ((ey1 + y) * zf));
            g.drawLine((int) ((sx2 + x) * zf), (int) ((sy2 + y) * zf),
                (int) ((ex2 + x) * zf), (int) ((ey2 + y) * zf));
            ...
            for (int n = 0; n < num_alpha_lanes; n++) {
                ...
                int dx = 6 * ((sx1 - alphaNode.coord.x) / Math.abs(sx1 -
                        alphaNode.coord.x));
                int dy = 6 * ((sy1 - alphaNode.coord.y) / Math.abs(sy1 -
                        alphaNode.coord.y));
                s = alphaLanes[n].getSign();

                if ((s != null) && (s.getType() == Sign.TRAFFICLIGHT)) {
                    g.setColor(s.mayDrive() ? Color.green : Color.red);
                    g.fillOval((int) (((x + (sx2 * part2) +
                        (sx1 * (1 - part2))) - 3 - dx) * zf),
                        (int) (((y + (sy2 * part2) + (sy1 * (1 - part2))) - 3 -
                        dy) * zf), 6, 6);
                }
                ...
                float ax = (float) sx1 +
                    ((float) signx * (float) 10.0 * ((float) 0.5 + n));
                float ay = (float) sy1 +
                    ((float) signy * (float) 10.0 * ((float) 0.5 + n));
                ...
                int ax1 = (int) ((x +
                    ((ax == bx) ? (int) ax
                                : Math.round((ax * (1 - p1)) + (bx * p1)))) * zf);
                int ay1 = (int) ((y +
                    ((ay == by) ? (int) ay
                                : Math.round((ay * (1 - p1)) + (by * p1)))) * zf);
                int ax2 = (int) ((x +
                    ((ax == bx) ? (int) ax
                                : Math.round((ax * (1 - p2)) + (bx * p2)))) * zf);
                int ay2 = (int) ((y +
                    ((ay == by) ? (int) ay
                                : Math.round((ay * (1 - p2)) + (by * p2)))) * zf);
                ...
                if (tars[0]) // left
                 {
                    g.drawLine(ax1, ay1, ax1 + (int) (signx * 3 * zf),
                        ay1 + (int) (signy * 3 * zf));
                }
                ...
                if (tars[1]) // straight
                 {
                    ...
                    g.drawLine(ax1, ay1,
                        (int) ((x +
                        ((ax == bx) ? (int) ax
                                    : Math.round((ax * (1 - p3)) + (bx * p3)))) * zf),
                        (int) ((y +
                        ((ay == by) ? (int) ay
                                    : Math.round((ay * (1 - p3)) + (by * p3)))) * zf));
                }
                    ...
                    while (li.hasNext()) {
                        ...
                        if (pos >= length) {
                            Point tp1 = new Point((int) (betaCoord.x -
                                    ...
                                    (int) (betaCoord.y +
                                    (5 * Math.sin(betaAngle))));
                            Point p = avg(getCurvePoint(tp1, betaAngle, -1, n,
                                        x, y),
                                    getCurvePoint(tp1, betaAngle, -1, n + 1, x,
                                        y));
                            paintRoaduserOnNode(g, ru, betaNode, p,
                                pos - length, alphaLanes[n]);
                        } else {
                            float part = (float) (pos + 1) / (length + 1);
                            ru.paint(g,
                                x +
                                ((ax == bx) ? (int) ax
                                            : Math.round((ax * (1 - part)) +
                                    (bx * part))),
                                y +
                                ((ay == by) ? (int) ay
                                            : Math.round((ay * (1 - part)) +
                                    (by * part))), zf,
                                Math.toRadians(180) + dlangle);
                        }
                    }
                }
            }
            ...
            for (int n = 0; n < num_beta_lanes; n++) {
                int dx = 6 * ((ex2 - betaNode.coord.x) / Math.abs(ex2 -
                        betaNode.coord.x));
                int dy = 6 * ((ey2 - betaNode.coord.y) / Math.abs(ey2 -
                        betaNode.coord.y));
                ...
                if ((s != null) && (s.getType() == Sign.TRAFFICLIGHT)) {
                    ...
                    g.setColor(s.mayDrive() ? Color.green : Color.red);
                    g.fillOval((int) (((x + (ex1 * part) + (ex2 * (1 - part))) -
                        3 - dx) * zf),
                        (int) (((y + (ey1 * part) + (ey2 * (1 - part))) - 3 -
                        dy) * zf), 6, 6);
                ...
                float ax = (float) sx2 +
                    ((float) signx * (float) 10.0 * ((float) 0.5 +
                    (num_beta_lanes - n - 1)));
                float ay = (float) sy2 +
                    ((float) signy * (float) 10.0 * ((float) 0.5 +
                    (num_beta_lanes - n - 1)));
                ...
                int ax1 = (int) ((x +
                    ((ax == bx) ? (int) ax
                                : Math.round((ax * p1) + (bx * (1 - p1))))) * zf);
                int ay1 = (int) ((y +
                    ((ay == by) ? (int) ay
                                : Math.round((ay * p1) + (by * (1 - p1))))) * zf);
                int ax2 = (int) ((x +
                    ((ax == bx) ? (int) ax
                                : Math.round((ax * p2) + (bx * (1 - p2))))) * zf);
                int ay2 = (int) ((y +
                    ((ay == by) ? (int) ay
                                : Math.round((ay * p2) + (by * (1 - p2))))) * zf);
                g.drawLine(ax1, ay1, ax2, ay2);
                ...
                if (tars[1]) // straight
                 {
                    ...
                    g.drawLine(ax1, ay1,
                        (int) ((x +
                        ((ax == bx) ? (int) ax
                                    : Math.round((ax * p3) + (bx * (1 - p3))))) * zf),
                        (int) ((y +
                        ((ay == by) ? (int) ay
                                    : Math.round((ay * p3) + (by * (1 - p3))))) * zf));
                }
                    ...
                    while (li.hasNext()) {
                        ...
                        if (pos >= length) {
                            Point tp1 = new Point((int) (alphaCoord.x -
                                    ...
                                    (int) (alphaCoord.y +
                                    (5 * Math.sin(alphaAngle))));
                            Point p = avg(getCurvePoint(tp1, alphaAngle, 1, n,
                                        x, y),
                                    getCurvePoint(tp1, alphaAngle, 1, n + 1, x,
                                        y));
                            paintRoaduserOnNode(g, ru, alphaNode, p,
                                pos - length, betaLanes[n]);
                        } else {
