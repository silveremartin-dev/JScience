...
/**
     ...
     */
    protected void doSave(String filename)
        throws InvalidFilenameException, Exception {
        boolean valid = validateInfra();

        if (!valid) {
            throw new InvalidFilenameException(
                "Can't save invalid infrastructure to file.");
        }

        if (!filename.endsWith(".infra")) {
            throw new InvalidFilenameException(
                "Filename must have .infra extension.");
        }
    ...
    public void showFilePropertiesDialog() {
        ...
        EditPropDialog propDialog = new EditPropDialog(this, title, author,
                comments);
    ...
    /**
     * Removes all objects from the infrastructure that are currently
     * selected
     */
     ...
     */
    protected class MousePosListener implements MouseListener,
        MouseMotionListener {
        /**
         * Sets the status bar text to be the current mouse
         * position.
         *
         * @param p DOCUMENT ME!
         */
        ...
        /**
         * Empty implementation, required by the MouseListener
         * interface.
         *
         * @param e DOCUMENT ME!
         */
