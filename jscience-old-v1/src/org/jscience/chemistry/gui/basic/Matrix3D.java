...
//this code is adapted from the code from Sun
...
/**
    ...
    public void transform(Atom atom) {
        ...
        atom.m_tx = ((x * lxx) + (y * lxy) + (z * lxz) + lxo);
        atom.m_ty = ((x * lyx) + (y * lyy) + (z * lyz) + lyo);
        atom.m_tz = ((x * lzx) + (y * lzy) + (z * lzz) + lzo);
    }

    /**
     * Transform nvert points from v into tv.  v contains the input
     * coordinates in doubleing point.  Three successive entries in the array
