 ...
 *
 * @author L. Maisonobe
 * @version $Id: Rotation3D.java,v 1.2 2007-10-21 17:38:26 virtualcall Exp $
 * @see Vector3D
 * @see Rotation3DOrder
 */
...
public class Rotation3D
     ...
     */
    public Rotation3D(double q0, double q1, double q2, double q3) {
        this.q0 = q0;
        this.q1 = q1;
        this.q2 = q2;
        this.q3 = q3;
     ...
     * @throws ArithmeticException if the axis norm is null
     */
     ...
     */
    public Rotation3D(double[][] m, double threshold)
            throws NotARotationMatrixException {

        // dimension check
        if ((m.length != 3) || (m[0].length != 3)
                || (m[1].length != 3) || (m[2].length != 3)) {
            throw new NotARotationMatrixException("matrix is not a 3X3 matrix");
        }
        ...
        if ((ort[0][0] * (ort[1][1] * ort[2][2] - ort[2][1] * ort[1][2])
                - ort[1][0] * (ort[0][1] * ort[2][2] - ort[2][1] * ort[0][2])
                + ort[2][0] * (ort[0][1] * ort[1][2] - ort[1][1] * ort[0][2])
        ) < 0.0) {
            throw new NotARotationMatrixException("closest orthogonal matrix"
     ...
     */
    public Rotation3D(Vector3D u1, Vector3D u2, Vector3D v1, Vector3D v2) {
        ...
        v1 = new LiteralVector3D(v1x, v1y, v1z);
        ...
        v2 = new LiteralVector3D(v2x, v2y, v2z);
        ...
        double dy2 = v2y - u2.y();
        double dz2 = v2z - u2.z();
        Vector3D k = new LiteralVector3D(dy1 * dz2 - dz1 * dy2,
                dz1 * dx2 - dx1 * dz2,
                dx1 * dy2 - dy1 * dx2);
        ...
        if (c < (1.0e-10 * u1u1 * u2u2)) {
            ...
            double dy3 = v3y - u3y;
            double dz3 = v3z - u3z;
            k = new LiteralVector3D(dy1 * dz3 - dz1 * dy3,
                    dz1 * dx3 - dx1 * dz3,
                    dx1 * dy3 - dy1 * dx3);
            ...
            if (c < (1.0e-10 * u1u1 * u3u3)) {
                ...
                k = new LiteralVector3D(dy2 * dz3 - dz2 * dy3,
                        dz2 * dx3 - dx2 * dz3,
                        dx2 * dy3 - dy2 * dx3);
        ...
        k = new LiteralVector3D(uRef.y() * q3 - uRef.z() * q2,
                uRef.z() * q1 - uRef.x() * q3,
                uRef.x() * q2 - uRef.y() * q1);
        c = k.dotProduct(k);
        q0 = vRef.dotProduct(k) / (c + c);
     ...
     * @throws ArithmeticException if the norm of one of the vectors is null
     */
    public Rotation3D(Vector3D u, Vector3D v) {
    ...
    public Rotation3D(Rotation3DOrder order,
        ...
        if (order == Rotation3DOrder.XYZ) {

            compose(new Rotation3D(Vector3D.plusI, alpha1),
                    new Rotation3D(Vector3D.plusJ, alpha2),
                    new Rotation3D(Vector3D.plusK, alpha3));

        } else if (order == Rotation3DOrder.XZY) {

            compose(new Rotation3D(Vector3D.plusI, alpha1),
                    new Rotation3D(Vector3D.plusK, alpha2),
                    new Rotation3D(Vector3D.plusJ, alpha3));

        } else if (order == Rotation3DOrder.YXZ) {

            compose(new Rotation3D(Vector3D.plusJ, alpha1),
                    new Rotation3D(Vector3D.plusI, alpha2),
                    new Rotation3D(Vector3D.plusK, alpha3));

        } else if (order == Rotation3DOrder.YZX) {

            compose(new Rotation3D(Vector3D.plusJ, alpha1),
                    new Rotation3D(Vector3D.plusK, alpha2),
                    new Rotation3D(Vector3D.plusI, alpha3));

        } else if (order == Rotation3DOrder.ZXY) {

            compose(new Rotation3D(Vector3D.plusK, alpha1),
                    new Rotation3D(Vector3D.plusI, alpha2),
                    new Rotation3D(Vector3D.plusJ, alpha3));

        } else if (order == Rotation3DOrder.ZYX) {

            compose(new Rotation3D(Vector3D.plusK, alpha1),
                    new Rotation3D(Vector3D.plusJ, alpha2),
                    new Rotation3D(Vector3D.plusI, alpha3));

        } else if (order == Rotation3DOrder.XYX) {

            compose(new Rotation3D(Vector3D.plusI, alpha1),
                    new Rotation3D(Vector3D.plusJ, alpha2),
                    new Rotation3D(Vector3D.plusI, alpha3));

        } else if (order == Rotation3DOrder.XZX) {

            compose(new Rotation3D(Vector3D.plusI, alpha1),
                    new Rotation3D(Vector3D.plusK, alpha2),
                    new Rotation3D(Vector3D.plusI, alpha3));

        } else if (order == Rotation3DOrder.YXY) {

            compose(new Rotation3D(Vector3D.plusJ, alpha1),
                    new Rotation3D(Vector3D.plusI, alpha2),
                    new Rotation3D(Vector3D.plusJ, alpha3));

        } else if (order == Rotation3DOrder.YZY) {

            compose(new Rotation3D(Vector3D.plusJ, alpha1),
                    new Rotation3D(Vector3D.plusK, alpha2),
                    new Rotation3D(Vector3D.plusJ, alpha3));

        } else if (order == Rotation3DOrder.ZXZ) {
     ...
     */
    private void compose(Rotation3D r1, Rotation3D r2, Rotation3D r3) {
        Rotation3D composed = r1.applyTo(r2.applyTo(r3));
        q0 = composed.q0;
        q1 = composed.q1;
        q2 = composed.q2;
        q3 = composed.q3;
    ...
    public Vector3D getAxis() {
        ...
        if (squaredSine < 1.0e-12) {
            return new LiteralVector3D(1, 0, 0);
        } else if (q0 < 0) {
            double inverse = 1 / Math.sqrt(squaredSine);
            return new LiteralVector3D(q1 * inverse, q2 * inverse, q3 * inverse);
        } else {
            double inverse = -1 / Math.sqrt(squaredSine);
            return new LiteralVector3D(q1 * inverse, q2 * inverse, q3 * inverse);
        }
    ...
    public double[] getAngles(Rotation3DOrder order)
        ...
        if (order == Rotation3DOrder.XYZ) {
            ...
            if ((v2.z() < minThreshold) || (v2.z() > maxThreshold)) {
                throw new CardanEulerSingularityException();
            }
            angles[0] = Math.atan2(-(v1.y()), v1.z());
            angles[1] = Math.asin(v2.z());
            angles[2] = Math.atan2(-(v2.y()), v2.x());
            ...
            v2 = applyInverseTo(Vector3D.plusI);
            if ((v2.y() < minThreshold) || (v2.y() > maxThreshold)) {
                throw new CardanEulerSingularityException();
            }
            angles[0] = Math.atan2(v1.z(), v1.y());
            angles[1] = -Math.asin(v2.y());
            angles[2] = Math.atan2(v2.z(), v2.x());
            ...
            angles[0] = Math.atan2(v1.x(), v1.z());
            angles[1] = -Math.asin(v2.z());
            angles[2] = Math.atan2(v2.x(), v2.y());
            ...
            v2 = applyInverseTo(Vector3D.plusJ);
            if ((v2.x() < minThreshold) || (v2.x() > maxThreshold)) {
                throw new CardanEulerSingularityException();
            }
            angles[0] = Math.atan2(-(v1.z()), v1.x());
            angles[1] = Math.asin(v2.x());
            angles[2] = Math.atan2(-(v2.z()), v2.y());
            ...
            angles[0] = Math.atan2(-(v1.x()), v1.y());
            angles[1] = Math.asin(v2.y());
            angles[2] = Math.atan2(-(v2.x()), v2.z());
            ...
            angles[0] = Math.atan2(v1.y(), v1.x());
            angles[1] = -Math.asin(v2.x());
            angles[2] = Math.atan2(v2.y(), v2.z());
    ...
    public Vector3D applyTo(Vector3D u) {
        ...
        return new LiteralVector3D(2 * (q0 * (x * q0 - (q2 * z - q3 * y)) + s * q1) - x,
    ...
    public Vector3D applyInverseTo(Vector3D u) {
        ...
        return new LiteralVector3D(2 * (m0 * (x * m0 - (q2 * z - q3 * y)) + s * q1) - x,
