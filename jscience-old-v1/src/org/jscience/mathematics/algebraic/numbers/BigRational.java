...
**
** @author Eric Laroche <laroche@lrdev.com>, silvere Martin-Michiellot (mostly downgrading)
** @version @(#)$Id: BigRational.java,v 1.2 2007-10-21 17:38:09 virtualcall Exp $
**
...
//WARNING: This class is not expected to be part of the public API
 ...
 *
 * @author Eric Laroche <laroche@lrdev.com>, June 2002, silvere Martin-Michiellot (mostly downgrading) May 2005
 * @version @(#)$Id: BigRational.java,v 1.2 2007-10-21 17:38:09 virtualcall Exp $
 *          <p/>
 *          <p/>
 ...
 *          mod, pow) are additionally defined as
...
//	implements Cloneable
{
    ...
    public BigRational(BigInteger n, BigInteger q) {
        if (bigIntegerZerop(q)) {
            throw new NumberFormatException("Quotient is zero.");
        }
    ...
    public String toStringDot(int precision, int radix) {
        checkRadix(radix);
        BigRational scaleValue = new BigRational(bigIntegerPow(bigIntegerValueOf(radix),
    ...
    public BigRational add(BigRational that) {
        ...
        if (bigIntegerEquals(m_q, that.m_q)) {
            return new BigRational(m_n.add(that.m_n),
                    m_q);
        }

        // optimization: second operand is an integer.
        if (that.integerp()) {
            return new BigRational(m_n.add(that.m_n.multiply(m_q)),
                    m_q);
        }

        // optimization: first operand is an integer.
        if (integerp()) {
            return new BigRational(m_n.multiply(that.m_q).add(that.m_n),
                    that.m_q);
        }
    ...
    public BigRational subtract(BigRational that) {
        ...
        // optimization: same denominator.
        if (bigIntegerEquals(m_q, that.m_q)) {
            return new BigRational(m_n.subtract(that.m_n),
                    m_q);
        }

        // optimization: second operand is an integer.
        if (that.integerp()) {
            return new BigRational(m_n.subtract(that.m_n.multiply(m_q)),
                    m_q);
        }

        // optimization: first operand is an integer.
        if (integerp()) {
            return new BigRational(m_n.multiply(that.m_q).subtract(that.m_n),
                    that.m_q);
        }
    ...
    public BigRational divide(BigRational that) {
        ...
        return new BigRational(bigIntegerMultiply(m_n, that.m_q),
    ...
    public BigRational mod(long that) {
        return mod(new BigRational(that));
    }
    ...
    public BigRational min(long that) {
        return min(new BigRational(that));
    }
    ...
    public BigRational max(long that) {
        return max(new BigRational(that));
    }
    ...
    public BigDecimal bigDecimalValue(int precision) {
        return new BigDecimal(toStringDot(precision, DEFAULT_RADIX));
    }
    ...
    public float floatValue() {
        return new Float(toStringDot(20, DEFAULT_RADIX)).floatValue();
    }
    ...
    public double doubleValue() {
        return new Double(toStringDot(40, DEFAULT_RADIX)).doubleValue();
    }
...
**		// power()
**		if (
**			!(new BigRational(3, 5)).pow(7).toString().equals("2187/78125") ||
**			!(new BigRational(-3, 5)).pow(7).toString().equals("-2187/78125") ||
**			!(new BigRational(3, 5)).pow(-7).toString().equals("78125/2187") ||
**			!(new BigRational(-3, 5)).pow(-7).toString().equals("-78125/2187") ||
**			!(new BigRational(3, 5)).pow(6).toString().equals("729/15625") ||
**			!(new BigRational(-3, 5)).pow(6).toString().equals("729/15625") ||
**			!(new BigRational(3, 5)).pow(0).toString().equals("1") ||
**			!(new BigRational(-3, 5)).pow(0).toString().equals("1") ||
**			!(new BigRational(0)).pow(1).toString().equals("0") ||
**			!(new BigRational(1)).pow(0).toString().equals("1")
**		) {
**			throw new RuntimeException("BigRational power");
**		}
**		if (
**			!(new BigRational(3, 5)).pow(0).equals(BigRational.ONE) ||
**			!(new BigRational(3, 5)).pow(1).equals(new BigRational(3, 5)) ||
**			!(new BigRational(3, 5)).pow(-1).equals((new BigRational(3, 5)).invert())
**		) {
**			throw new RuntimeException("BigRational more power");
**		}
**
**		try {
**			(new BigRational(0)).pow(0);
...
**		// modulus()
**		if (
**			!(new BigRational(5)).mod(new BigRational(3)).equals(new BigRational(2)) ||
**			!(new BigRational(-5)).mod(new BigRational(3)).equals(new BigRational(1)) ||
**			!(new BigRational(5)).mod(new BigRational(-3)).equals(new BigRational(-1)) ||
**			!(new BigRational(-5)).mod(new BigRational(-3)).equals(new BigRational(-2)) ||
**			!(new BigRational(0)).mod(new BigRational(1)).equals(new BigRational(0)) ||
**			!(new BigRational("5.6")).mod(new BigRational("1.8")).equals(new BigRational(1, 5)) ||
**			!(new BigRational("-5.6")).mod(new BigRational("1.8")).equals(new BigRational(8, 5)) ||
**			!(new BigRational("5.6")).mod(new BigRational("-1.8")).equals(new BigRational(-8, 5)) ||
**			!(new BigRational("-5.6")).mod(new BigRational("-1.8")).equals(new BigRational(-1, 5)) ||
**			!(new BigRational("1")).mod(new BigRational("0.13")).equals(new BigRational("0.09"))
**		) {
...
**		// absolute()
**		if (
**			!(new BigRational(0)).abs().toString().equals("0") ||
**			!(new BigRational(3, 5)).abs().toString().equals("3/5") ||
**			!(new BigRational(-3, 5)).abs().toString().equals("3/5")
**		) {
...
**		// minimum()
**		if (
**			!(new BigRational(3, 5)).min(new BigRational(7, 11)).toString().equals("3/5") ||
**			!(new BigRational(-3, 5)).min(new BigRational(7, 11)).toString().equals("-3/5") ||
**			!(new BigRational(3, 5)).min(new BigRational(-7, 11)).toString().equals("-7/11") ||
**			!(new BigRational(-3, 5)).min(new BigRational(-7, 11)).toString().equals("-7/11") ||
**			!(new BigRational(7, 11)).min(new BigRational(3, 5)).toString().equals("3/5")
**		) {
...
**		// maximum()
**		if (
**			!(new BigRational(3, 5)).max(new BigRational(7, 11)).toString().equals("7/11") ||
**			!(new BigRational(-3, 5)).max(new BigRational(7, 11)).toString().equals("7/11") ||
**			!(new BigRational(3, 5)).max(new BigRational(-7, 11)).toString().equals("3/5") ||
**			!(new BigRational(-3, 5)).max(new BigRational(-7, 11)).toString().equals("-3/5") ||
**			!(new BigRational(7, 11)).max(new BigRational(3, 5)).toString().equals("7/11")
**		) {
