 ...
 */
//we could also add a couple of methods here:
//isNaN, isInfinite, hashCode 
public final class Supernumber extends Number implements Cloneable, Serializable,
        Ring.Member {
    private final int N = 4;
    private Complex body = Complex.ZERO;
    private Complex[] soul1 = {
            Complex.ZERO, Complex.ZERO, Complex.ZERO, Complex.ZERO
    };
    private Complex[] soul2 = {
            Complex.ZERO, Complex.ZERO, Complex.ZERO, Complex.ZERO, Complex.ZERO,
            Complex.ZERO
    };
    private Complex[] soul3 = {
            Complex.ZERO, Complex.ZERO, Complex.ZERO, Complex.ZERO
    };
    private Complex soul4 = Complex.ZERO;

    //The Class instance representing the primitive type supernumber.
    public static final Class TYPE = new Supernumber().getClass();
     ...
     */
    public Supernumber(Supernumber s) {
     ...
     * Constructs a supernumber. We don't perform any check though we should.
     */
    public Supernumber(Complex body, Complex[] soul1, Complex[] soul2, Complex[] soul3, Complex soul4) {
