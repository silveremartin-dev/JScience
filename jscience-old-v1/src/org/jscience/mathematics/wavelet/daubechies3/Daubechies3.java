package org.jscience.mathematics.wavelet.daubechies3;
 ...
 */
public final class Daubechies3 extends Multiresolution implements Filter {
    /** DOCUMENT ME! */
    ...
    final static double[] vgtemp = {
            .332670552950, .806891509311, .459877502118, -.135011020010,
            -.085441273882, .035226291882
        };

    /** DOCUMENT ME! */
    final static double[] v0temp = { 0.689047760315, 0.724715933318 };

    /** DOCUMENT ME! */
    final static double[] v1temp = {
            0.0306457241755, -0.0291374408035, -0.986047279405, 0.161005005859
        };

    /** DOCUMENT ME! */
    final static double[] v2temp = {
            0.0172802631418, -0.0164297845102, 0.00443452721664, 0.0208960300827,
            -0.924034270866, 0.380966943247
        };

    /** DOCUMENT ME! */
    final static double[] v3temp = {
            0.027026368393, -0.0256962180001, 0.0639688879804, 0.381971870809,
            0.176750229211, 0.404677356783, -0.747429432607, 0.308155135811
        };

    /** DOCUMENT ME! */
    final static double[] vd0temp = { 0.889500699418, 0.456933808921 };

    /** DOCUMENT ME! */
    final static double[] vd1temp = {
            -0.198411021088, 0.386241373662, 0.832668382346, 0.343677222149
        };

    /** DOCUMENT ME! */
    final static double[] vd2temp = {
            0.0390630495665, -0.0760429831027, -0.143921176769, 0.456707890812,
            0.807766275151, 0.33303120718
        };

    /** DOCUMENT ME! */
    final static double[] vd3temp = {
            -0.000276799784313, 0.000538838660959, 0.0349752642807,
            -0.085504178774, -0.134969198046, 0.459895243878, 0.806892290508,
            0.332670875027
        };
    ...
    /** DOCUMENT ME! */
    final static double[] vd2 = ArrayMathUtils.scalarMultiply(MathConstants.SQRT2,
            ArrayMathUtils.invert(vd2temp));

    /** DOCUMENT ME! */
    final static double[] vd3 = ArrayMathUtils.scalarMultiply(MathConstants.SQRT2,
            ArrayMathUtils.invert(vd3temp));
    ...
    final static double[] phv0 = {
            0.720522830617, -0.685061028561, 0.0259917491699, -0.101939535681,
            0.0200641216304, -0.00827216838973
        };

    /** DOCUMENT ME! */
    final static double[] phv1 = {
            0.0639675079235, -0.0608192341872, 0.151405112504, 0.904072212264,
            -0.0510574707719, -0.18071490589, 0.315790060572, -0.130196008824
        };

    /** DOCUMENT ME! */
    final static double[] phvd0temp = {
            -0.409742284317, 0.797634233593, -0.419058128916, -0.117669342504,
            0.0741631890253, 0.0305764886814
        };
    ...
    final static double[] phvd1temp = {
            -0.00261427398522, 0.00508913652903, 0.330328738376, -0.807556085169,
            0.460310974517, 0.13519444871, -0.0854338960798, -0.0352232501168
        };
...
/**
     * Creates a new Daubechies3 object.
     */
    public Daubechies3() {
    }
