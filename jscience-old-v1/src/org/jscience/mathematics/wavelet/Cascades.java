 ...
 */
public final class Cascades extends Object {
/**
     * Creates a new Cascades object.
     */
    private Cascades() {
    }
        ...
        if (((2 * i) - filtretype) == k) {
            ...
            if ((2 * Math.round(k / 2d)) == k) {
                throw new IllegalScalingException(
                    "Odd number of values into an even filter! Change the number of values/iterations: " +
                    k);
            } else {
                throw new IllegalScalingException(
                    "Even number of values into an odd filter! Change the number of values/iterations: " +
                    k);
            }
        }
    }
    ...
    public static double[] evalScaling(Filter filtre, int n0, int j1, int k) {
        ...
        if (n0 <= 0) {
            throw new IllegalArgumentException(
                "Must have a positive number of scaling functions : " + n0 +
                " < 0.");
        }
        ...
        if ((k >= init.length) || (k < 0)) {
            throw new IllegalArgumentException("There are " + init.length +
                " scaling functions going from 0 to " + (init.length - 1) +
                " and you are trying to get the " + k + "th function.");
        }
     ...
     * @throws IllegalArgumentException DOCUMENT ME!
     */
    public static double[] evalWavelet(Filter filtre, int filtretype, int n0,
        int j1, int k) {
        if (j1 > 20) {
            throw new IllegalArgumentException("Too many iterations : " + j1);
        }
        ...
        if ((n0 - filtretype) <= 0) {
            throw new IllegalArgumentException("With " + n0 +
                " scaling functions and a filter of type " + filtretype +
                ", you are left with no wavelets. Please change the number of scaling functions, the multiresolution or the number of iterations");
        }
        ...
        if ((k >= init.length) || (k < 0)) {
            throw new IllegalArgumentException("There are " + init.length +
                " wavelets going from 0 to " + (init.length - 1) +
                " and you are trying to get to the " + k + "th wavelet.");
        }
     ...
     * @return DOCUMENT ME!
     */
    public static double[] evalWaveletQuadratic(Filter filtre, int n0, int j1,
        int k) {
    ...
    public static int PowerOf2(int pwrOf2) {
        if (pwrOf2 < 0) {
            throw new IllegalArgumentException(
                "This parametre must be positive : " + pwrOf2 + " < 0");
        }
    ...
    /**
     * method used to oversample according to the lazy (Dirac Delta
    ...
    /**
     * Starting with n0 scaling functions and going jfin scales ahead
     * (iterating jfin times), tells you how many scaling functions you'll
     * have. (Dyadic multiresolutions of type filtretype.)
     *
     ...
     * Starting with n0 scaling functions and going jfin scales ahead
     * (iterating jfin times), tells you how many scaling functions you'll
     * have. (Linear spline and dyadic multiresolution of type 1.)
     *
     * @param n0 number of scaling functions initially
     * @param jfin number of iterations
     *
     ...
     * Starting with n0 scaling functions and going jfin scales ahead
     * (iterating jfin times), tells you how many scaling functions you'll
     * have. (Haar and dyadic multiresolution of type 0.)
     *
     * @param n0 number of scaling functions initially
     * @param jfin number of iterations
     *
    ...
    public static double[] evaluation(Filter filtre, int j1, double[] init) {
        if (j1 < 0) {
            throw new IllegalArgumentException("Incorrect parameters : " + j1 +
                " < 0 ");
        }

        if (j1 > 20) {
            throw new IllegalArgumentException(
                "Excessive number of iterations: " + j1);
        }
