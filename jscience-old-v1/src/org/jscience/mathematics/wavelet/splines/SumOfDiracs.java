...
/**
 * This class is used to generate sum of Diracs (splines of order 0) to be
 * used as wavelets or related functions. It can also be used for basic
 * interpolation.
 *
...
/**
    ...
    public boolean equals(Object a) {
        if ((a != null) && (a instanceof SumOfDiracs) &&
                (vecteur.length == ((SumOfDiracs) a).dimension())) {
     ...
     * dyadic implementation). This serves as the defintion for the "Filter
    ...
    public int previousDimension(int k) {
        ...
        if (((2 * i) - 1) == k) {
            ...
            throw new IllegalArgumentException(
                "Even number of values into an odd Filter! Change the number of data values/of iterations.");
        }
    }
    ...
    public double[] lowpass(double[] gete) {
        ...
        sortie[0] = ArrayMathUtils.scalarProduct(ArrayMathUtils.extract(0, 1,
                    data), v0);
