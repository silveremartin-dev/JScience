...
import org.jscience.measure.random.CorrelatedRandomVectorGenerator;
import org.jscience.measure.random.NotPositiveDefiniteMatrixException;
import org.jscience.measure.random.RandomVectorGenerator;
import org.jscience.measure.random.UncorrelatedRandomVectorGenerator;
 ...
 * algorithm. In multi-start mode, the {@link #minimizes minimizes}
 ...
 * {@link #minimizes minimizes} method).</p>
 * <p/>
 ...
 * @version $Id: DirectSearchOptimizer.java,v 1.2 2007-10-21 17:45:47 virtualcall Exp $
 * @see CostFunction
 * @see NelderMead
...
public abstract class DirectSearchOptimizer {
     ...
     * @throws CostException          if the cost function throws one during
     *                                the search
     * @throws NoConvergenceException if none of the starts did
    ...
    public PointCostPair minimizes(CostFunction f, int maxEvaluations,
        ...
        RandomVectorGenerator rvg =
                new UncorrelatedRandomVectorGenerator(mean, standardDeviation,
                        new UniformNormalizedRandomGenerator(seed));
     ...
     * restarts when multi-start mode is enabled. The {@link #minimizes
     * minimizes} method returns the best point only. This method
     * returns all the points found at the end of each starts, including
     * the best one already returned by the {@link #minimizes minimizes}
     ...
     * #minimizes minimizes} method throwed a {@link
     * NoConvergenceException NoConvergenceException}).</p>
     *
    ...
    private PointCostPair minimizes(CostFunction f, int maxEvaluations,
        ...
        if (minima[0] == null) {
            throw new NoConvergenceException("none of the start points lead to convergence");
        }
        return minima[0];
