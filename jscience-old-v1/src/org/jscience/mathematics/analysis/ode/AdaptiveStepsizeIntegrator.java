 ...
 *
 * @author L. Maisonobe
 * @version $Id: AdaptiveStepsizeIntegrator.java,v 1.2 2007-10-21 17:38:17 virtualcall Exp $
 */
...
public abstract class AdaptiveStepsizeIntegrator
     ...
     * @throws IntegrationException if the step is too small and acceptSmall is false
     */
    protected double filterStep(double h, boolean acceptSmall)
        ...
        if (Math.abs(h) < minStep) {
            if (acceptSmall) {
                ...
                throw new IntegrationException("minimal step size reached:"
                        + " minimal step allowed is " + minStep
                        + " but integration needs " + Math.abs(h));
            }
        }
