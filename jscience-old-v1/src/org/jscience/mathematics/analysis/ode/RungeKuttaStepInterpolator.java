 ...
 *
 * @author L. Maisonobe
 * @version $Id: RungeKuttaStepInterpolator.java,v 1.2 2007-10-21 17:38:17 virtualcall Exp $
...
abstract class RungeKuttaStepInterpolator
     ...
     * any, i.e. only if the step handler either calls the {@param
     * #finalizeStep finalizeStep} method or the {@link
     * #getInterpolatedState getInterpolatedState} method (for an
     * interpolator which needs a finalization) or if it clones the step
     * interpolator.</p>
     *
