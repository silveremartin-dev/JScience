...
import org.jscience.mathematics.analysis.estimation.EstimationProblem;
 ...
 *
 * @author L. Maisonobe
 * @version $Id: HarmonicFitter.java,v 1.2 2007-10-21 17:38:16 virtualcall Exp $
 */
    ...
    public double[] fit()
        ...
        if (firstGuessNeeded) {
            if (measurements.size() < 4) {
                throw new EstimationException("too short sample");
            }
            ...
            try {
                ...
                EstimationException ee = new EstimationException();
                ee.initCause(e);
                throw ee;
