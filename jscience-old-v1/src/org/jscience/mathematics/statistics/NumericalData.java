 ...
 * @version August, 2003
 */
public class NumericalData implements Serializable, Named {
    //Variables
    /** DOCUMENT ME! */
    ...
    //Variables
    /** DOCUMENT ME! */
    private Vector orderStatistics = new Vector();
...
/**
    ...
    /**
     * This method adds a new number to the data set and re-compute the
     * mean, mean square, minimum and maximum values, and order statistics.
     *
    ...
    /**
     * This method returns the value of the data set corresponding to a
     * given index.
     *
     * @param i the index
     *
    ...
    /**
     * This method gets the standard deviation of the data set treated
     * as a population.
     *
    ...
    /**
     * This method gets the variance of the data set treated as a
     * sample.
     *
     * @return the variance
     */
    ...
    /**
     * This method gets the sample standard deviation of the data set
     * treated as a sample.
     *
     * @return the standard deviation
     */
    ...
    /**
     * This method gets the name of the data set. return the name of
     * the data set
     *
     * @return DOCUMENT ME!
     */
