 ...
 * @version August, 2003
 */
public class ConvolutionDistribution extends Distribution
...
/**
    ...
    /**
     * This method sets the parameters: the distribution and
     * convolution power. The method computes and stores the values of the
    ...
    public void setParameters(Distribution d, int n) {
        ...
        for (int k = 1; k < n; k++) {
            for (int j = 0; j < (((k + 1) * m) - k); j++) {
                ...
                for (int i = Math.max(0, j - m + 1);
                        i < Math.min(j + 1, (k * m) - k + 1); i++) {
    ...
    /**
     * This method computes the mean of the convolution distribution in
     * terms of the mean of the given distribution and the convolution power.
     *
     * @return the mean
     */
    ...
    /**
     * This method computes the variance of the convolution
     * distribution in terms of the variance of the given distribution and the
     * convolution power.
     *
     * @return the variance
     */
    ...
    /**
     * This method computes the moment generating function of the
     * convolution distribution in terms of the moment generating function of
     * the given distribution and the convolution power.
     *
    ...
    /**
     * This method simulates a value from the convolution distribution
     * by computing a sum of simulated values from the given distribuiton.
     *
    ...
    public String toString() {
        return "Convolution distribution [basic distribution = " +
