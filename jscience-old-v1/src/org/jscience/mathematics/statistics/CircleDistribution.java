...
/**
 * This class models the crcle distribution with a specified radius.  This
 * is the distribution of X and Y when (X, Y) has the uniform distribution on
 * a circular region centered at the origin, with the given radius.
 *
...
/**
     * This default constructor creates a new circle distribution with radius
     * 1.
     */
    ...
    /**
     * This method sets the radius parameter and computes the domain of
     * the distribution.
     *
     * @param r the radius
     */
    ...
    /**
     * This method computes the variance in terms of the radius
     * parameter.
     *
     * @return the variance
     */
    ...
    /**
     * This method computes the median which is 0 regardless of the
     * radius parameter.
     *
     * @return the median
     */
     ...
     * done by simulating a point chosen uniformly in the circle of the
     * specified radius, centered at the origin, and then computing the
    ...
    /**
     * This method compute the cumulative distribution functionin in
     * terms of the radius parameter.
     *
     * @param x a number in the domain of the distribution
     *
    ...
    /**
     * This method computes the quantile function in terms of the
     * radius parameter.
     *
    ...
    public double getQuantile(double p) {
        if (p <= 0) {
            ...
            return radius * Math.sin(Math.PI * (p - 0.5));
        }
    }
