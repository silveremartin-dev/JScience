...
/**
 * The class models the Poisson distribution with a specified rate
 * parameter.
 *
...
/**
     * This default constructor creates a new Poisson distribtiton with
     * parameter 1.
     */
    ...
    /**
     * This method sets the parameter and creates the domain of the
     * distribution.
     *
     * @param r the rate parameter
     */
    ...
    public double getDensity(double x) {
        ...
        if (parameter == 0) {
            ...
            if (k < 0) {
                ...
                return Math.exp((-parameter + (k * Math.log(parameter))) -
                    StatisticsUtils.logGamma(k + 1));
            }
        }
    }
     ...
     * terms of the gamma cumulative distribution function.
     *
     * @param x a number in the domain of the distribution
     *
    ...
    public double getCDF(double x) {
        return 1 - StatisticsUtils.gammaCDF(parameter, x + 1);
    }
     ...
     * simulating the number of arrivals in an interval of parameter length in
