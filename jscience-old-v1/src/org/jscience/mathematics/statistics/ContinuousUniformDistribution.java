...
/**
    ...
    /**
     * This method sets the parameters: the minimum and maximum values
     * of the interval. The default domain is sepcified.
     *
     ...
     * which is any value, since the density function is constant.
     *
     ...
     * specified point, in terms of the parameters.
     *
     * @param a the center
     * @param n the order
     *
    ...
    public double getMoment(double a, int n) {
        return (Math.pow(upperBound - a, n + 1) -
        Math.pow(lowerBound - a, n + 1)) / ((n + 1) * (upperBound - lowerBound));
    }
    ...
    public double getMGF(double t) {
        if (t == 0) {
            ...
            return (Math.exp(upperBound * t) - Math.exp(lowerBound * t)) / (t * (upperBound -
            lowerBound));
        }
    }
    ...
    /**
     * This method gets the lower bound of the domain of the
     * distribution.
     *
