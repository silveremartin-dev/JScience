...
/**
 * This class defines a simple implementation of an interval data
 * distribution. The data distribution is based on a specified domain (that
 * is, a partition of an interval). When values are added, frequency counts
 * for the subintervals are computed and various statistic updated.
 *
 * @author Kyle Siegrist
 * @author Dawn Duehring
 * @version August, 2003
 */
public class IntervalData implements Serializable, Named {
    //Variables
    /** DOCUMENT ME! */
    private int size;
...
/**
     ...
     * @param n the name
     */
    public IntervalData(DistributionDomain d, String n) {
        name = n;
        setDomain(d);
    }
...
/**
     * This general constructor creates a new data distribution with a
     * specified (continuous) domain and a        specified name.
     *
    ...
    public IntervalData(double a, double b, double w, String n) {
        this(new DistributionDomain(a, b, w, 1), n);
    }
...
/**
     ...
     * @param d the domain
     */
    public IntervalData(DistributionDomain d) {
        this(d, "X");
    }

/**
     * This spcial constructor creates a new data distribution with a specified
     * (continuous) domain and        the name "X".
     *
     * @param a the lower bound
     * @param b the upper bound
     * @param w the step size
...
/**
     ...
     * @param d the domain
     */
    public void setDomain(DistributionDomain d) {
        domain = d;
        reset();
    }
    ...
    /**
     * This method resets the data set. The frequency distribution is
     * cleared and the minimum and maximum values are reset.
     */
    public void reset() {
    ...
    /**
     * This method adds a new number to the data set and re-computes
     * the mean, mean square, minimum and maximum values, the frequency
     * distribution, and the mode.
     *
    ...
    public void setValue(double x) {
        ...
        meanSquare = (((double) (size - 1) / size) * meanSquare) +
            ((value * value) / size);
        ...
        if ((i >= 0) & (i < domain.getSize())) {
            ...
            if (freq[i] > maxFreq) {
                ...
                mode = Double.NaN; //There are two or more modes
            }
        }
    }
    ...
    /**
     * This method returns the domain value (midpoint) closest to given
     * value of x.
     *
    ...
    /**
     * This method returns the frequency of the class containing a
     * given value.
     *
     * @param x a real number
     *
    ...
    /**
     * This method returns the relative frequency of the class
    ...
    /**
     * This method returns the density of the data distribution at a
     * given value. The density is the relative frequency divided by the width
     * of the subinterval.
     *
     * @param x a real number
     *
    ...
    /**
     * This method returns the mean of the frequency distribution.  The
     * interval mean is an approximation of the true mean of the data set, and
     * is equivalent to rounding each value in the data set to the nearest
     * interval midpoint.
     *
    ...
    /**
     * This method returns the variance of the data set treated as a
     * population (that is, the sum is divided by the number of points n
     * rather than n &minus; 1).
     *
     * @return the variance
     */
    ...
    /**
     * This method returns the standard deviation of the data set
     * treated as a population (that is, the sum is divided by the number of
     * points n rather than n &minus; 1).
     *
     * @return DOCUMENT ME!
     */
    ...
    /**
     * This method returns the variance of the data set treated as a
     * sample (that is, the sum is divided by n &minus; 1 where n is the
     * number of points).
     *
     * @return the variance.
     */
    ...
    /**
     * This method returns the standard deviation of the data set
     * treated as a sample (that is, the sum is divided by n &minus; 1 where n
     ...
     * This is an approximation to the true variance, and is equivalent to
    ...
    /**
     * This method computes the median of the values in the data set
    ...
    /**
     * This method computes the mean absoulte deviation from the
     * median.
     *
    ...
    /**
     * This method returns the maximum relative frequency of the data
     * set.
     *
    ...
    /**
     * This method returns the mode of the distribution, if it is
     * unique. Otherwise, the mode does not exist. The mode is the midpoint of
     * the interval with the largest frequency.
     *
     * @return the mode
     */
