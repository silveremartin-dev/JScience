 ...
 * @version 1.1a
 */
public class EcuyerGenerator extends RandomSeedable implements Serializable {
    /**
     ...
     */
    public EcuyerGenerator(int s1, int s2) {
        iseed1 = s1;
        iseed2 = s2;
    }
    ...
    */
     ...
     */
    final public void nextDouble(double[] d, int n) {
        int i;
        int k;
        int iz;
