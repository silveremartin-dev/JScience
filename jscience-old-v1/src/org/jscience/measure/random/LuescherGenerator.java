 ...
 * @version 1.1a
 */
public class LuescherGenerator extends RandomSeedable implements Serializable {
    /**
     ...
     */
    public LuescherGenerator(int lux, int ins) {
        init_arrays();
     ...
     */
    public LuescherGenerator(int lux, long ins) {
        init_arrays();
     ...
     */
    public LuescherGenerator(int lux, Date d) {
        init_arrays();
     ...
     * @param d date used to generate seed
     */
    public LuescherGenerator(Date d) {
        init_arrays();
