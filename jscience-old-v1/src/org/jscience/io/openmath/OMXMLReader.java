/*
 * $Id: OMXMLReader.java,v 1.2 2007-10-21 17:45:05 virtualcall Exp $
 *
...
public class OMXMLReader extends DefaultHandler {
     ...
     * @throws SAXException when something is seriously wrong.
     */
    public void endElement(String fNamespaceURI, String fLocalName,
                           String fRawName) throws SAXException {
        if (fLocalName.equals("OMOBJ")) {
            mOMObject = (OMObject) mElementStack.lastElement();
            mElementStack.removeElement(mElementStack.lastElement());
        } else {
            if (mElementStack.size() > 1) {
                OMObject tObject = (OMObject) mElementStack.elementAt(mElementStack.size() -
                        2);
     ...
     * @throws SAXException when something is seriously wrong.
     */
    public void startElement(String fNamespaceURI, String fLocalName,
                             String fRawName, Attributes fAttributes) throws SAXException {
