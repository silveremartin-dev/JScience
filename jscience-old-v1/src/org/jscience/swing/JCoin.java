 ...
 * of heads. The state of the coin can be tossed or not tossed. If tossed, the
 * coin is drawn with a color and label that depend on the outcome (heads or
 * tails). If not tossed, the coin is shown as an outline in the background
 * color.
 *
 ...
 * @version August, 2003
 */
public class JCoin extends JComponent {
    /** DOCUMENT ME! */
...
/**
     * This general constructor creates a new coin with a probability,
     * preferred size, and colors.
     *
     ...
     */
    public JCoin(double p, int s, Color a, Color b, Color c) {
...
/**
     * This special constructor creates a new coin with a specified probability
     * and size, and with the default colors of red for heads and green for
     * tails.
     *
     * @param p the probability of heads.
     * @param s the size of the coin.
     */
    public JCoin(double p, int s) {
        this(p, s, Color.red, new Color(0, 180, 0), Color.white);
    }

/**
     * This special  constructor creates a coin with a specified probability of
     * heads, and with the default size 40,  and with head color red and tail
     * color green.
     *
     * @param p DOCUMENT ME!
     */
    public JCoin(double p) {
        this(p, 32);
    }
...
/**
    ...
    public void paintComponent(Graphics g) {
        ...
        if (tossed) {
            ...
            g.drawString(labels[value], (size / 2) - (x / 2),
                (size / 2) + (y / 2));
        }
    }
    ...
    /**
     * This method sets the value to a random value, as determined by
