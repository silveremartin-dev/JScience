 ...
 * @version August, 2003
 */
public class JCard extends JComponent implements Serializable {
    /** DOCUMENT ME! */
    ...
    /** DOCUMENT ME! */
    public final static String[] suitName = {
            "Clubs", "Diamonds", "Hearts", "Spades"
        };

    /** DOCUMENT ME! */
    public final static String[] valueName = {
...
/**
     * This general constructor creates a new card of a specified value and
     * suit and specified state (up or down).
     *
     ...
     */
    public JCard(int i, int j, boolean b) {
        faceUp = b;
        setToolTipText("Card");
        setScore(i, j);
    }
...
/**
     ...
     * @param j the suit (0 clubs, 1 diamonds, 2 hearts, 3 spades)
     */
    public JCard(int i, int j) {
        this(i, j, false);
    }

/**
     * This general constructor creates a new card of a specified number and a
     * specified state (face up or down)
     *
     * @param n the card number (0 to 12 clubs, 13 to 25 diamonds, 26 to 38
     *          hearts, 39 to 51 spades).
     * @param b true if the card face is showing
     */
    public JCard(int n, boolean b) {
        setToolTipText("Card");
        faceUp = b;
        setCardNumber(n);
    }
...
/**
     * This special constructor creates a new card of a specified number that
     * is face down.
     *
     * @param n the card number (0 to 12 clubs, 13 to 25 diamonds, 26 to 38
     *          hearts, 39 to 51 spades).
...
/**
     * This default constructor creates a new card randomly chosen from the
     * deck that is face down.
     */
    public JCard() {
    ...
    /**
     * This method sets the card to a value, as specified by a number
     * from 0 to 51.
     *
     * @param n the card number (0 to 12 clubs, 13 to 25 diamonds, 26 to 38
     *        hearts, 39 to 51 spades).
    ...
    /**
     * This method returns the number of the card from 0 to 51. Cards 0
     * to 12 are the clubs (in order); cards 13 to 25 are the diamonds (in
     * order); cards 26 to 38 are the hearts (in order); and cards 39 to 51
     * are the spades (in order).
     *
     * @return DOCUMENT ME!
     */
    ...
    /**
     * This methood sets the card to a specific card, as specified by
     * the suit and value.
     *
     ...
     *
     * @param b true if the card face is shown, false if the card back is
     *        shown.
     */
