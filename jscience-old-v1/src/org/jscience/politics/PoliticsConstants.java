...
/**
 * A class representing politics useful constants.
 *
 * @author Silvere Martin-Michiellot
 * @version 1.0
 */

//see also EconomicsConstants
public final class PoliticsConstants extends Object {
    /** DOCUMENT ME! */
    ...
    //there is a better way to do that, but I can't remember how to do it.
    //mutually exclusive
    //from wikipedia, form of governement
    /** DOCUMENT ME! */
    ...
    /** DOCUMENT ME! */
    public final static int AUTOCRACY = 2; //Autocracy and Dictatorship
    ...
    //Socialist republic
    //Soviet Republic
    //we could add to the list the corporatocracy
    /** DOCUMENT ME! */
    ...
    //this list changes from time to time, so be careful
    ...
    /** DOCUMENT ME! */
    public final static String PM = "Stpublic final static String  Pierre and Miquelon";
    ...
    /** DOCUMENT ME! */
    public final static String SH = "Stpublic final static String  Helena";
    ...
    /** DOCUMENT ME! */
    public final static String VN = "Vietnam";

    /** DOCUMENT ME! */
    public final static String VU = "Vanuatu";

    /** DOCUMENT ME! */
    public final static String WF = "Wallis and Futuna Islands";

    /** DOCUMENT ME! */
    public final static String WS = "Western Samoa";

    /** DOCUMENT ME! */
    public final static String YE = "Yemen";

    /** DOCUMENT ME! */
    public final static String YT = "Mayotte";

    /** DOCUMENT ME! */
    public final static String YU = "Yugoslavia";

    /** DOCUMENT ME! */
    public final static String ZA = "South Africa";

    /** DOCUMENT ME! */
    public final static String ZM = "Zambia";

    /** DOCUMENT ME! */
    public final static String ZW = "Zimbabwe";

    /** DOCUMENT ME! */
    public final static String COM = "US Commercial";

    /** DOCUMENT ME! */
    public final static String EDU = "US Educational";

    /** DOCUMENT ME! */
    public final static String GOV = "US Government";

    /** DOCUMENT ME! */
    public final static String INT = "International";

    /** DOCUMENT ME! */
    public final static String MIL = "US Military";

    /** DOCUMENT ME! */
    public final static String NET = "Network";

    /** DOCUMENT ME! */
    public final static String ORG = "Non-Profit Organization";

    /** DOCUMENT ME! */
    public final static String ARPA = "Old style Arpanet";

    /** DOCUMENT ME! */
    public final static String NATO = "Nato field";
}
