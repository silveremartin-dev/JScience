package org.jscience.visualization.backends;

import org.jscience.visualization.Plot2D;
import org.jscience.visualization.PlotFormat;
import org.jscience.visualization.PlottingBackend;
...
public class JavaFXPlot2D implements Plot2D {
    ...
    public void save(String filename, PlotFormat format) {
        ...
        throw new UnsupportedOperationException("Export not yet implemented for JavaFX backend");
    }
