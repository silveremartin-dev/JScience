 ...
 * @since 1.0
 */
public class DenseStorage<E> implements MatrixStorage<E> {

    private final List<List<E>> data;
    private final int rowsCount;
    private final int colsCount;

    public DenseStorage(List<List<E>> data) {
    ...
    public DenseStorage(int rows, int cols, E initialValue) {
