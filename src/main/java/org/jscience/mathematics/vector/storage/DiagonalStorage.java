 ...
 * @since 1.0
 */
public class DiagonalStorage<E> implements MatrixStorage<E> {
    ...
    public DiagonalStorage(E[] diagonal, Field<E> field) {
    ...
    public MatrixStorage<E> clone() {
        ...
        return new DiagonalStorage<>(copy, null); // Field not needed for clone
    }
