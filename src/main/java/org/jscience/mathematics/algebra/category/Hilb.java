...
import org.jscience.mathematics.algebra.HilbertSpace;
 ...
 * @since 1.0
 */
public class Hilb implements Category<HilbertSpace<?, ?>, Matrix<?>> {

    private static final Hilb INSTANCE = new Hilb();

    public static Hilb getInstance() {
        return INSTANCE;
    }
