...
set APP_CLASS=org.jscience.apps.physics.relativity.RelativisticFlightApp
...
java --module-path "%LIBS%" --add-modules javafx.controls,javafx.graphics -cp "%MODULE_PATH%;%LIBS%" %APP_CLASS%
