...
public class SmartGridApp extends KillerAppBase {
    ...
    private VBox createChartsPane() {
        ...
        loadChart.getData().addAll(supplySeries, demandSeries);
        ...
        statusLabel.setStyle("-fx-font-size: 18px; -fx-background-color: #4CAF50; -fx-text-fill: white; -fx-padding: 5 10 5 10; -fx-background-radius: 4;");
    ...
    private VBox createControlRoom() {
        ...
        box.getChildren().addAll(title, coalBox, windBox, solarBox, new Separator(), demandBox, tripReset);
        return box;
    }
    ...
    private void updateTick() {
        ...
        double windFactor = Math.abs(Math.sin(time * 0.2) + Math.sin(time * 0.7) * 0.5) * 0.8; // Chaotic wind
    ...
    private void updateStatus() {
        ...
        if (Math.abs(gridFrequency - 50) < 0.5) {
            ...
            statusLabel.setStyle("-fx-font-size: 18px; -fx-background-color: #FF5722; -fx-text-fill: white; -fx-padding: 5 10 5 10; -fx-background-radius: 4;");
        }
    ...
    private void triggerBlackout(String reason) {
        ...
        statusLabel.setStyle("-fx-font-size: 18px; -fx-background-color: #000000; -fx-text-fill: red; -fx-padding: 5 10 5 10; -fx-background-radius: 4;");
